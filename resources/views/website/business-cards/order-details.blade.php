...
@section('title', 'Business Card Order Details - Professional Print Services')
<style>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">{{ $businessCard->name }}</div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Company</div>
                                        <div class="info-value">{{ $businessCard->company ?? 'Not provided' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-item">
                                        <div class="info-label">Email</div>
                                        <div class="info-value">{{ $businessCard->email }}</div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Phone</div>
                                        <div class="info-value">{{ $businessCard->phone ?? 'Not provided' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <span class="status-badge status-pending">{{ ucfirst($order->businessCard->text_font) }}</span>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Shap</div>
                                        <div class="info-value">
                                            <span class="status-badge status-pending">{{ ucfirst($order->businessCard->card_shape) }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <span class="status-badge status-pending">{{ ucfirst($order->businessCard->card_orientation) }}</span>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Weight</div>
                                        <div class="info-value">
                                            <span class="status-badge status-{{ $order->status }}">{{ ucfirst($order->businessCard->card_weight) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <span class="status-badge status-pending">{{ ucfirst($order->paper_stock) }}</span>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <div class="info-label">Corner Style</div>
                                        <div class="info-value">
                                            <span class="status-badge status-pending">{{ ucfirst($order->corner_style) }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            <span class="status-badge status-processing">{{ number_format($order->quantity) }} cards</span>
                                        </div>
                                    </div>
                                    <div class="info-item">
                    ...
                    <div class="order-card">
                        ...
                        <div class="order-card-body">
                            @if(is_array($order->upload_files) && count($order->upload_files) > 0)
                                @php
                                    $frontFiles = [];
                                    $backFiles = [];
                                ...
                                @if(count($frontFiles) > 0)
                                    <div class="mb-4">
                                        <h6 class="text-primary-theme-light mb-3">
                                            <i class="fas fa-id-card me-2"></i>Front Design Files ({{ count($frontFiles) }})
                                        </h6>
                                        @foreach($frontFiles as $file)
                                        <div class="uploaded-file-item">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div>
                                                    <h6 class="mb-1 text-primary-theme-light">{{ basename($file) }}</h6>
                                ...
                                @if(count($backFiles) > 0)
                                    <div class="mb-4">
                                        <h6 class="text-primary-theme-light mb-3">
                                            <i class="fas fa-id-card me-2"></i>Back Design Files ({{ count($backFiles) }})
                                        </h6>
                                ...
                                @if(count($frontFiles) == 0 && count($backFiles) == 0)
                    ...
                    <div class="summary-sidebar">
                        ...
                        <div class="order-card-body">
                            ...
                            <div class="summary-item">
                                ...
                                <span class="summary-value">{{ ucfirst($order->paper_stock) }}</span>
                            </div>
                            <div class="summary-item">
                                <span class="summary-label">Corner Style:</span>
                                <span class="summary-value">{{ ucfirst($order->corner_style) }}</span>
                            </div>
                            <div class="summary-item">
                                <span class="summary-label">Quantity:</span>
                                <span class="summary-value">{{ number_format($order->quantity) }} cards</span>
                            </div>
                            <div class="summary-item">
                                <span class="summary-label">Files:</span>
                                <span class="summary-value">{{ is_array($order->upload_files) ? count($order->upload_files) : 0 }} uploaded</span>
                            </div>
                            @if($order->corner_style === 'rounded')
                            <div class="summary-item">
                                <span class="summary-label">Rounded Corners:</span>
                                <span class="summary-value text-secondry-theme">+${{ number_format($order->quantity * 0.02, 2) }}</span>
                            </div>
                            @endif
                            <hr>
                            <div class="summary-item">
                                <span class="summary-label"><strong>Total Price:</strong></span>
                                <span class="summary-value total-price">${{ number_format($order->total_price, 2) }}</span>
                            </div>
                            ...
                            <div class="action-buttons-container">
                                <a href="{{ route('business-cards.show', $order->business_card_id) }}" class="action-btn">
                                    <i class="fas fa-eye me-2"></i>View Business Card
                                </a>
                                
                                <a href="{{ route('business-cards.order') }}" class="action-btn secondary">
