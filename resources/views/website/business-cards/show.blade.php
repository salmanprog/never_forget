                    ...
                    <div class="card-preview-section">
                        <div class="row justify-content-center text-center mb-4">
                            <div class="col-lg-12">
                                ...
                                <span class="status-badge status-{{ $businessCard->status }}">{{ ucfirst($businessCard->status) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="text-center mb-6">
                            <div class="card-preview-3d">
                                <div class="card-inner">
                                    ...
                                    <img src="{{ asset('public/storage/' .$businessCard->card_front_image) }}" alt="Front Side">
                                    </div>
                                    <div class="card-back">
                                    <img src="{{ asset('public/storage/' . $businessCard->card_back_image) }}" alt="Back Side">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="space-y-3">
                                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                            ...
                                            <span class="text-primary-theme-light fw-600">{{ $businessCard->name }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                            <span class="text-light-black fw-500">Job Title:</span>
                                            <span
                                                class="text-primary-theme-light">{{ $businessCard->job_title ?? 'Not provided' }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center py-2">
                                            <span class="text-light-black fw-500">Company:</span>
                                            <span
                                                class="text-primary-theme-light">{{ $businessCard->company ?? 'Not provided' }}</span>
                                        </div>
                        </div>
                    </div>
                            </div>
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="space-y-3">
                                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                            ...
                                            <span
                                                class="text-primary-theme-light">{{ $businessCard->phone ?? 'Not provided' }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                            <span class="text-light-black fw-500">Email:</span>
                                            <span
                                                class="text-primary-theme-light">{{ $businessCard->email ?? 'Not provided' }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                            <span class="text-light-black fw-500">Website:</span>
                                            <span
                                                class="text-primary-theme-light">{{ $businessCard->website ?? 'Not provided' }}</span>
                        </div>
                                        @if ($businessCard->address)
                                        <div class="d-flex justify-content-between align-items-center py-2">
                                            <span class="text-light-black fw-500">Address:</span>
                                                <span
                                                    class="text-primary-theme-light text-end">{{ $businessCard->address }}</span>
                                        </div>
                                @endif
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                                ...
                                <select class="form-select">
                                    <option value="standard"
                                        {{ $businessCard->corner_style === 'standard' ? 'selected' : '' }}>Standard (Square)
                                    </option>
                                    <option value="rounded"
                                        {{ $businessCard->corner_style === 'rounded' ? 'selected' : '' }}>Rounded Corners
                                        (+$0.02/card)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <a href="{{ route('business-cards.order') }}" class="btn secondry-btn w-100">
                    ...
                    <div class="contact-form-container mt-4">
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('business-cards.edit', $businessCard) }}" class="btn secondry-btn w-100">
                                <i class="fas fa-edit mr-2"></i>Edit Design
                            </a>
                            <a href="{{ route('business-cards.index') }}" class="btn secondry-btn w-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Business card data
    const businessCardData = @json($businessCard);
    ...
    function loadTextures(frontFiles, backFiles, frontMaterial, backMaterial) {
        ...
        // Load front texture
        if (frontFiles.length > 0) {
            const frontImagePath = '{{ asset("admin/assets/images/business_cards/uploads/") }}' + frontFiles[0];
        ...
        // Load back texture
        if (backFiles.length > 0) {
            const backImagePath = '{{ asset("admin/assets/images/business_cards/uploads/") }}' + backFiles[0];
