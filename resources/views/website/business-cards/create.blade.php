...
@section('title', 'Order Business Cards - Professional Printing Service')
<style>
                ...
                <div class="col-lg-6">
                    <div class="contact-form-container">
                        <form id="business-card-order-form" class="form-horizontal" method="post"
                            action="{{ route('business-cards.store') }}" enctype="multipart/form-data">
                            @csrf
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function handleFormSubmit(event) {
                ...
                fetch("{{ route('business-cards.store') }}", {
                        method: 'POST',
                        body: formData,
                        headers: {
