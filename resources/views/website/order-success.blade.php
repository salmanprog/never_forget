...
<div class="success-container">
    ...
    @if(session('order'))
        <div class="order-details">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ date('M d, Y', strtotime(session('order')->order_date)) }}</span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    <span class="detail-value">{{ ucfirst(session('order')->payment_status) }}</span>
                </span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Order Status:</span>
                <span class="detail-value">
                    <span class="detail-value">{{ session('order')->order_status }}</span>
                </span>
            </div>
        </div>
    @endif
    ...
    <div class="action-buttons">
        ...
        @if(Auth::check())
            <a href="{{ route('order.index') }}" class="btn-success">
                <i class="fa fa-list"></i> View My Orders
            </a>
        @else
            <a href="{{ route('index') }}" class="btn-success">
