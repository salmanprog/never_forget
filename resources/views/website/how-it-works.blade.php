    ...
    <div class="container">
      ...
      <div class="row row-gap-40 text-center text-lg-start" data-aos="fade-down" data-aos-easing="ease-out-cubic"
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card-wrapper bg-transparent">
            <div class="mb-34 sm-circle lg-circle d-flex align-items-center justify-content-center">
              <img src="{{asset('public/assets/website/images')}}/icons/message.svg" alt="">
            </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card-wrapper bg-transparent">
            <div class="mb-34 sm-circle lg-circle d-flex align-items-center justify-content-center">
              <img src="{{asset('public/assets/website/images')}}/icons/settings.svg" alt="">
            </div>
            <div class="card-bottom">
              <h5 class="heading text-secondry-theme-light fs-40 fw-600 mb-20">
                Customization
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card-wrapper bg-transparent">
            <div class="mb-34 sm-circle lg-circle d-flex align-items-center justify-content-center">
              <img src="{{asset('public/assets/website/images')}}/icons/delivery.svg" alt="">
            </div>
            <div class="card-bottom">
              <h5 class="heading text-secondry-theme-light fs-40 fw-600 mb-20">
                Delivery
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center mt-70" data-aos="flip-left" data-aos-easing="ease-out-cubic"
          ...
          <div class="d-flex align-content-center justify-content-center">
            <a href="{{ route('contact-us') }}" class="btn primary-btn border-0">Contact Our Team</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row row-gap-40 text-center text-lg-start">
        ...
        <div class="col-lg-6">
          <div class="img-wrapper position-relative" data-aos="fade-right" data-aos-easing="ease-out-cubic"
            data-aos-duration="1000">
            <img src="{{asset('public/assets/website/images')}}/hiw-sec-4.png" alt="">
          </div>
        </div>
        <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic"
          ...
          <a href="{{ route('contact-us') }}" class="btn primary-btn border-0">Contact Us For Customize Gifting</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row row-gap-40 flex-column-reverse flex-lg-row">
        ...
        <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic"
          ...
          <a href="{{ route('contact-us') }}" class="btn primary-btn border-0">Contact Us For Gifting Plans</a>
        </div>
        <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic"
          data-aos-duration="1000">
          <div class="img-wrapper position-relative">
            <img src="{{asset('public/assets/website/images')}}/hiw-sec-5.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row row-gap-40 text-center text-lg-start">
        ...
        <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic"
          data-aos-duration="1000">
          <div class="img-wrapper position-relative">
            <img src="{{asset('public/assets/website/images')}}/hiw-sec-6.png" alt="">
          </div>
        </div>
        <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic"
          data-aos-duration="1000">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="d-flex justify-content-center">
            <a href="{{ route('contact-us') }}" class="btn primary-btn border-0 text-center">Contact Our Team</a>
          </div>
        </div>
      </div>
    </div>
