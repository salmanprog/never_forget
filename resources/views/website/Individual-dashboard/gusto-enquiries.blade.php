...
@section('content')
    <input type="hidden" id="page_url" value="{{ $page_url ?? route('member.gusto-enquiries') }}">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="body">
                                    @include('website.individual-dashboard.gusto-enquiries-partials.table', ['enquiries' => $enquiries])
                                </tbody>
                            </table>
                        </div>
                    </div>
