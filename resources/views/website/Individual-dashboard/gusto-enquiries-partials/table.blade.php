...
@php
    $selected = $enquiry->selected_services;
...
<tr class="enquiry-summary-row">
    ...
    <td>
        <button type="button" class="btn btn-xs btn-default btn-toggle-enquiry-detail" data-target="gusto-detail-{{ $enquiry->id }}" aria-expanded="false">
            <i class="fa fa-chevron-down"></i> View details
        </button>
    </td>
</tr>
<tr class="enquiry-detail-row" id="gusto-detail-{{ $enquiry->id }}" style="display: none;">
        ...
        <div class="p-3">
            ...
            <table class="table table-bordered table-condensed mt-2 mb-0">
                <tbody>
                    ...
                    @endif
                    <tr>
                        <th width="180">Selected Services</th>
                        <td>
                            @if(count($selected))
                                <ul class="mb-0 pl-3">
