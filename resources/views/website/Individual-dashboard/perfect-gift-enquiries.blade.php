...
@section('content')
    <input type="hidden" id="page_url" value="{{ $page_url ?? route('member.perfect-gift-enquiries') }}">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="body">
                                    @include('website.individual-dashboard.perfect-gift-enquiries-partials.table', ['perfectGiftEnquiries' => $perfectGiftEnquiries])
                                </tbody>
                            </table>
                        </div>
                    </div>
