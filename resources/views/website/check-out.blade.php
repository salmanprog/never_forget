    ...
    <div class="row g-4">
                    ...
                    <div id="step-2" style="display:none;">
                        ...
                        <div id="payment-authorize-area" style="display:none;">
                            ...
                            <div class="alert alert-warning mb-3" role="alert">
                                <strong>Local testing:</strong> Authorize.net requires HTTPS. Use <a href="https://ngrok.com/download" target="_blank" rel="noopener">ngrok</a> (<code>ngrok http 80</code>) and open the HTTPS URL, or enable SSL in XAMPP. See <code>LOCAL_HTTPS_TEST.md</code> in the project.
                            </div>
                            @endif --}}
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <button type="button" class="checkout-btn mt-0" id="submit-authorize-btn">
                                    <span class="lock-icon"><i class="fa fa-lock"></i></span>
                                    <span id="authorize-btn-text">Pay with Card (${{ number_format(\Cart::getTotal(), 2) }})</span>
                                </button>
                            </div>
                        </div>
                        @endif
        ...
        <div class="col-lg-5 order-1 order-lg-2 order-summary-mobile">
            <div class="order-summary-card order-summary-sticky">
                ...
                <span id="discount-value" data-discount="{{ Session::has('discount') ? Session::get('discount')['discount'] : 0 }}" style="display:none;"></span>
