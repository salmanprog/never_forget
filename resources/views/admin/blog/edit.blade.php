				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control texteditor" name="description" style="height:200px;">{!! $model->description !!}</textarea>
						...
						@if($model->image)
							<div class="form-group">
								...
								<div class="col-sm-9" style="padding-top:5px">
									<img src="{{ asset('public/admin/assets/posts/'.$model->image) }}" alt="Blog" height="150px" width="150px">
								</div>
							</div>
						@endif
						<div class="form-group">
