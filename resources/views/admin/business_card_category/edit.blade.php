...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="{{ route('business_card_categories.index') }}" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('business_card_categories.update', $model->id) }}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				{{ method_field('PATCH') }}
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="parent_id" id="parent_id" class="form-control">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ $model->parent_id == $category->id ? 'selected':'' }}>{{ $category->title }}</option>
                                    @endforeach
                                </select>
						...
						{{-- <div class="form-group">
                            ...
                            @if(!empty($model->image))
                                <div class="col-sm-4">
                                    <img style="width: 80px" src="{{ asset('public/admin/assets/images/business_card_categories') }}/{{ $model->image }}" alt="">
                                </div>
                            @else
                                <div class="col-sm-4" >
