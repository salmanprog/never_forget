...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="{{ route('catering_service.index') }}" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('catering_service.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				<div class="box box-info">
					<div class="box-body"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                    <img style="width: 100px" id="banner_preview"  src="{{ asset('public/admin/assets/images/default.jpg') }}"  alt="Image Not Found ">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                    <img style="width: 100px" id="banner_previeww"  src="{{ asset('public/admin/assets/images/default.jpg') }}"  alt="Image Not Found ">
                            </div>
                        </div>
						<div class="form-group">
