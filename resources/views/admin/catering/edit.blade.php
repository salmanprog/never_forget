...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{route('catering_service.update', $model->id)}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				{{ method_field('PATCH') }}
				<div class="box box-info">
					<div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 100px " src="{{ asset('public/admin/assets/images/catering') }}/{{ $model->first_image }}" alt="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 100px " src="{{ asset('public/admin/assets/images/catering') }}/{{ $model->second_image }}" alt="">
                            </div>
                        </div>
						<div class="form-group">
