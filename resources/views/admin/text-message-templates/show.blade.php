...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="{{ route('text-message-templates.index') }}" class="btn btn-primary btn-sm">All templates</a>
    </div>
</section>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="input-group" style="display: block;">
                            <textarea class="form-control" style="margin-bottom: 10px; resize: vertical;" id="textBody" rows="6" readonly>{{ $template['body'] }}</textarea>
