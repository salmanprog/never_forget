                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab_1">
                        @foreach($Pageview as $view)
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Banner Heading </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="banner_heading" class="form-control" value="{{$view->banner_heading}}">
                                    </div>
                                </div>
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="top_sec_heading" class="form-control" value="{{$view->top_sec_heading}}" placeholder="e.g Condidate">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Title  </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="top_sec_title" class="form-control" value="{{$view->top_sec_title}}" placeholder="Enter title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Description  </label>
                                        <div class="col-sm-6">
                                            <textarea name="top_sec_description" id="" class="form-control" placeholder="Enter description here...">{{ $view->top_sec_description }}</textarea>
                                        </div>
                                    </div>
                                    @if(isset($view->top_sec_image))
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Existing Image</label>
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                <img src="{{ asset('public//public/admin/assets/images/page/'.$view->top_sec_image) }}" class="existing-photo" style="height:180px;">
                                            </div>
                                        </div>
                                    @endif
                                    <div class="form-group">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Heading  </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="middle_sec_heading" class="form-control" value="{{$view->middle_sec_heading}}" placeholder="e.g Interviewer">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Title  </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="middle_sec_title" class="form-control" value="{{$view->middle_sec_title}}" placeholder="Enter title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Description  </label>
                                        <div class="col-sm-6">
                                            <textarea name="middle_sec_description" id="" class="form-control" placeholder="Enter description here...">{{ $view->middle_sec_description }}</textarea>
                                        </div>
                                    </div>
                                    @if($view->middle_sec_image)
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Existing Image</label>
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                <img src="{{ asset('public//public/admin/assets/images/page/'.$view->middle_sec_image) }}" class="existing-photo" style="height:180px;">
                                            </div>
                                        </div>
                                    @endif
                                    <div class="form-group">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Heading  </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="bottom_sec_heading" class="form-control" value="{{$view->bottom_sec_heading}}" placeholder="e.g Connect">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Title  </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="bottom_sec_title" class="form-control" value="{{$view->bottom_sec_title}}" placeholder="Enter title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Description  </label>
                                        <div class="col-sm-6">
                                            <textarea name="bottom_sec_description" id="" class="form-control" placeholder="Enter description here...">{{ $view->bottom_sec_description }}</textarea>
                                        </div>
                                    </div>
                                    @if($view->bottom_sec_image)
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Existing Image</label>
                                            <div class="col-sm-6" style="padding-top:6px;">
                                                <img src="{{ asset('public//public/admin/assets/images/page/'.$view->bottom_sec_image) }}" class="existing-photo" style="height:180px;">
                                            </div>
                                        </div>
                                    @endif
                                    <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                @if($view->home_welcome_image_bg)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_welcome_image_bg) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif`
                                <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                @if($view->counter_photo)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->counter_photo) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                @if($view->home_booking_photo)
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_booking_photo) }}" class="" existing-photo="" style=" height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_title" class="form-control" value="{{$view->home_mock_advantage_title}}" placeholder="Enter title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">SubTitle </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_subtitle" class="form-control" value="{{$view->home_mock_advantage_subtitle}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Show on Home? </label>
                                    <div class="col-sm-2">
                                        <select name="home_mock_advantage_status" class="form-control select2 select2-accessible" style="width:auto;" tabindex="-1" aria-hidden="true">
                                            <option value="1" {{ $view->home_mock_advantage_status == 1 ? 'selected':'' }}>Show</option>
                                            <option value="0" {{ $view->home_mock_advantage_status == 0 ? 'selected':'' }}>Hide</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_first_label" class="form-control" value="{{$view->home_mock_advantage_bottom_first_label}}" placeholder="Enter Label">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">First Counter </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_first_counter" class="form-control" value="{{$view->home_mock_advantage_bottom_first_counter}}" placeholder="Enter Counter">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Second Label </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_second_label" class="form-control" value="{{$view->home_mock_advantage_bottom_second_label}}" placeholder="Enter Label">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Second Counter </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_second_counter" class="form-control" value="{{$view->home_mock_advantage_bottom_second_counter}}" placeholder="Enter counter">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Third Label </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_third_label" class="form-control" value="{{$view->home_mock_advantage_bottom_third_label}}" placeholder="Enter Label">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Third Counter </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_third_counter" class="form-control" value="{{$view->home_mock_advantage_bottom_third_counter}}" placeholder="Enter Counter">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fourth Label </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_fourth_label" class="form-control" value="{{$view->home_mock_advantage_bottom_fourth_label}}" placeholder="Enter Label">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fourth Counter </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_mock_advantage_bottom_fourth_counter" class="form-control" value="{{$view->home_mock_advantage_bottom_fourth_counter}}" placeholder="Enter Counter">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Show on Home? </label>
                                    <div class="col-sm-2">
                                        <select name="home_mock_advantage_counter_status" class="form-control select2 select2-accessible" style="width:auto;" tabindex="-1" aria-hidden="true">
                                            <option value="1" {{ $view->home_mock_advantage_counter_status == 1 ? 'selected':'' }}>Show</option>
                                            <option value="0" {{ $view->home_mock_advantage_counter_status == 0 ? 'selected':'' }}>Hide</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_title" class="form-control" value="{{$view->home_real_title}}" placeholder="Enter title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">SubTitle </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_subtitle" class="form-control" value="{{$view->home_real_subtitle}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">First Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_bottom_first_title" class="form-control" value="{{$view->home_real_bottom_first_title}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">First Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_real_bottom_first_description" id="" class="form-control" placeholder="Enter description">{{$view->home_real_bottom_first_description}}</textarea>
                                    </div>
                                </div>
                                @if($view->home_real_bottom_first_icon)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_real_bottom_first_icon) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_bottom_second_title" class="form-control" value="{{$view->home_real_bottom_second_title}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Second Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_real_bottom_second_description" id="" class="form-control" placeholder="Enter description">{{$view->home_real_bottom_second_description}}</textarea>
                                    </div>
                                </div>
                                @if($view->home_real_bottom_second_icon)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_real_bottom_second_icon) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_bottom_third_title" class="form-control" value="{{$view->home_real_bottom_third_title}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Third Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_real_bottom_third_description" id="" class="form-control" placeholder="Enter description">{{$view->home_real_bottom_third_description}}</textarea>
                                    </div>
                                </div>
                                @if($view->home_real_bottom_third_icon)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_real_bottom_third_icon) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_bottom_fourth_title" class="form-control" value="{{$view->home_real_bottom_fourth_title}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fourth Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_real_bottom_fourth_description" id="" class="form-control" placeholder="Enter description">{{$view->home_real_bottom_fourth_description}}</textarea>
                                    </div>
                                </div>
                                @if($view->home_real_bottom_fourth_icon)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_real_bottom_fourth_icon) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_bottom_fifth_title" class="form-control" value="{{$view->home_real_bottom_fifth_title}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Fifth Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_real_bottom_fifth_description" id="" class="form-control" placeholder="Enter description">{{$view->home_real_bottom_fifth_description}}</textarea>
                                    </div>
                                </div>
                                @if($view->home_real_bottom_fifth_icon)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_real_bottom_fifth_icon) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="home_real_bottom_sixth_title" class="form-control" value="{{$view->home_real_bottom_sixth_title}}" placeholder="Enter sub title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Sixth Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_real_bottom_sixth_description" id="" class="form-control" placeholder="Enter description">{{$view->home_real_bottom_sixth_description}}</textarea>
                                    </div>
                                </div>
                                @if($view->home_real_bottom_sixth_icon)
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Existing Image</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="{{ asset('public//public/admin/assets/images/page/'.$view->home_real_bottom_sixth_icon) }}" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="home_real_status" class="form-control select2 select2-accessible" style="width:auto;" tabindex="-1" aria-hidden="true">
                                            <option value="1" {{ $view->home_real_status == 1 ? 'selected':'' }}>Show</option>
                                            <option value="0" {{ $view->home_real_status == 0 ? 'selected':'' }}>Hide</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <form action="{{ route('page.home_setting')}}" class="form-horizontal" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_signup_title" class="form-control" value="{{$view->home_signup_title}}" placeholder="Enter sign up title">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Description </label>
                                    <div class="col-sm-6">
                                        <textarea name="home_signup_description" id="" class="form-control" placeholder="Enter sign up description">{{$view->home_signup_description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Button Label </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_signup_btn_label" class="form-control" value="{{$view->home_signup_btn_label}}" placeholder="Enter sign up button label">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Show on Home? </label>
                                    <div class="col-sm-2">
                                        <select name="home_signup_status" class="form-control select2 select2-accessible" style="width:auto;" tabindex="-1" aria-hidden="true">
                                            <option value="1" {{ $view->home_signup_status == 1 ? 'selected':'' }}>Show</option>
                                            <option value="0" {{ $view->home_signup_status == 0 ? 'selected':'' }}>Hide</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
