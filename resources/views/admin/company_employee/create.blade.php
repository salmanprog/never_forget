...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.company_employee.store') }}" id="employee-form" class="form-horizontal" method="post" accept-charset="utf-8">
                @csrf
                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('client_status') }}" name="client_status" id="client_status" placeholder="Client Status">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('client_since') }}" name="client_since" id="client_since" placeholder="Client Since">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('department') }}" name="department" id="department" placeholder="Department">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('employee_id') }}" name="employee_id" id="employee_id" placeholder="Employee ID">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('job_title') }}" name="job_title" id="job_title" placeholder="Job Title">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="{{ old('hire_date') }}" name="hire_date" id="hire_date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('employment_status') }}" name="employment_status" id="employment_status" placeholder="Employment Status">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('shipping_address') }}" name="shipping_address" id="shipping_address" placeholder="Shipping Address">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="{{ old('work_anniversary_date') }}" name="work_anniversary_date" id="work_anniversary_date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('hobbies') }}" name="hobbies" id="hobbies" placeholder="Hobbies">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('dietry_restriction') }}" name="dietry_restriction" id="dietry_restriction" placeholder="Dietry Restriction">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="{{ old('budget_range') }}" name="budget_range" id="budget_range" placeholder="Budget Range">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="{{ old('gift_send_date') }}" name="gift_send_date" id="gift_send_date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="delivery_notes" id="delivery_notes" rows="2" placeholder="Delivery Note">{{ old('delivery_notes') }}</textarea>
