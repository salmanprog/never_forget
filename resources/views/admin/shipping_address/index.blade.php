...
@section('content')
<input type="hidden" id="page_url" value="{{ route('shipping_address.index') }}">
<section class="content-header">
	<div class="content-header-left">
		<h1>All Shipping Address</h1>
	</div>
	<div class="content-header-right">
		<a href="{{ route('shipping_address.create') }}" class="btn btn-primary btn-sm">Add Shipping Address</a>
	</div>
</section>
						...
						<tbody id="body">
							@foreach($models as $key=>$model)
								<tr id="id-{{ $model->id }}">
									...
									<td width="250px">
										<a href="{{route('shipping_address.edit', $model->id)}}" data-toggle="tooltip" data-placement="top" title="Edit post" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
