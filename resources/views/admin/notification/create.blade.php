...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('notification.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" placeholder="Enter notification title" required>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="description" id="description" style="height:140px;" placeholder="Enter notification description">{{ old('description') }}</textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="module" id="module" value="{{ old('module') }}" placeholder="Enter module name (e.g., order, product)">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" class="form-control" name="module_id" id="module_id" value="{{ old('module_id') }}" placeholder="Enter module ID">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="module_slug" id="module_slug" value="{{ old('module_slug') }}" placeholder="Enter module slug">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="reference_module" id="reference_module" value="{{ old('reference_module') }}" placeholder="Enter reference module name">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="number" class="form-control" name="reference_id" id="reference_id" value="{{ old('reference_id') }}" placeholder="Enter reference ID">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="reference_slug" id="reference_slug" value="{{ old('reference_slug') }}" placeholder="Enter reference slug">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="is_view" id="is_view" class="form-control">
									<option value="0" {{ old('is_view') == '0' ? 'selected' : '' }}>Not Viewed</option>
									<option value="1" {{ old('is_view') == '1' ? 'selected' : '' }}>Viewed</option>
								</select>
