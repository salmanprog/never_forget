...
<section class="content-header">
    ...
    <div class="content-header-right">
        ...
        <a href="{{ route('member.friends_family.index') }}" class="btn btn-primary btn-sm">Back to Friends/Family</a>
    </div>
</section>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <ul class="list-unstyled" style="margin-bottom: 16px;">
                        <li><i class="fa fa-users" style="color: #081e37;"></i> <strong>{{ $package['friends_family'] }}</strong> friends/family included</li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @else
                    ...
                    <form action="{{ route('member.package-upgrade.paypal') }}" method="POST" style="margin-bottom: 16px;" id="paypal-form">
                        @csrf
                    ...
                    <div class="card-form">
                        ...
                        <form action="{{ route('member.package-upgrade.charge') }}" method="POST" id="card-form">
                            @csrf
