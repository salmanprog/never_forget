...
<head>
    <title>Gusto Enquiry Received - Never Forget</title>
            ...
            <td align="center" style="padding: 20px 0;">
                <div class="email-container">
                    ...
                    <div class="content-section">
                        ...
                        <p class="message-text">Thank you for submitting your Gusto enquiry. We have received it and will follow up shortly.</p>
                        <div class="summary-box">
                            <p><strong>Name:</strong> {{ $senderName }}</p>
                            <p><strong>Email:</strong> {{ $email }}</p>
                            <p><strong>Phone:</strong> {{ $phone ?? 'Not specified' }}</p>
                            <p><strong>Selected Services:</strong> {{ $selected_services ?? '—' }}</p>
