				...
				<div class="box box-info">
					<div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 80px " src="<?php echo e(asset('public/admin/assets/images/about_us')); ?>/<?php echo e($model->first_image); ?>" alt="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 80px " src="<?php echo e(asset('public/admin/assets/images/about_us')); ?>/<?php echo e($model->second_image); ?>" alt="">
                            </div>
                        </div>
						<div class="form-group">
