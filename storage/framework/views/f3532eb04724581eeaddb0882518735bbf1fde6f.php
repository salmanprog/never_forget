...
<section class="content-header">
	<div class="content-header-left">
		<h1>Account Settings & Support</h1>
	</div>
...
<section class="content">
    ...
    <div class="box box-info" style="padding: 20px;">
        <h3>manage credentials and reach support easily.</h3>
    </div>
</section>
