            ...
            <div class="col-md-12">
                <div class="cart-of-table cart-table">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $enquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($enquiry->category && $enquiry->category->image): ?>
                                            <img src="<?php echo e(asset('/public/' . $enquiry->category->image)); ?>"
                                                alt="<?php echo e($enquiry->category->title); ?>"
                                                style="width: 100px; height: 100px; object-fit: cover;">
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php echo e($enquiry->category->title ?? ''); ?>
                    ...
                    <?php if(count($enquiries) > 0): ?>
                        ...
                        <form action="<?php echo e(route('greetings-appreciation.enquiry')); ?>" class="field-wrapper enquiry-form">
                            <?php echo csrf_field(); ?>
                            <div class="row row-gap-20">
                                <input type="hidden" name="greetings_category_ids"
                                    value="<?php echo e(implode(',', $item_category_ids)); ?>">
                                <?php if(!$user): ?>
                                    <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php endif; ?>
                                <?php if(!empty($showSpecifyType)): ?>
                                    <div class="col-12">
                                        <input type="text" id="specify_type" class="input-field" name="specify_type"
                                            placeholder="Specify type" value="<?php echo e(old('specify_type')); ?>" />
                                        <?php $__errorArgs = ['specify_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<script>
    $(document).ready(function() {
            ...
            Swal.fire({
                ...
                if (response.isConfirmed) {
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '<?php echo e(url('/greetings-appreciation-items')); ?>/' + id,
                                ...
                                row.fadeOut(300, function() {
                                    ...
                                    if ($('tbody tr').length === 0) {
                                        window.location.href =
                                            "<?php echo e(route('shop', ['category' => 'greetings-appreciation'])); ?>";
                                    }
                                });
        ...
        $(document).on('click', '.plus, .minus', function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('greetings-appreciation-items.update-quantity')); ?>",
                data: {
