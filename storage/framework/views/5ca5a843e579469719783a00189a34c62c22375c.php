            ...
            <div class="slider product-category-slider" data-aos="fade-down" data-aos-easing="ease-out-cubic"
                ...
                <div class="card-wrapper">
                    <div class="category-image mb-20" style="background: #f15c22;padding: 3px;">
                        <img src="<?php echo e(asset('public/assets/website/images/tango/tango.png')); ?>"
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card-bottom text-center">
                        ...
                        <a href="<?php echo e(route('shop', ['category' => 'gusto'])); ?>"
                            class="btn primary-btn border-0"><span>GET STARTED</span></a>
                    </div>
                </div>
            </div>
