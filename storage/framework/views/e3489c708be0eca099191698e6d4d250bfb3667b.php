...
<?php $__env->startSection('content'); ?>
    <input type="hidden" id="page_url" value="<?php echo e(route('business-card.orders')); ?>">
                                ...
                                <tbody id="body">
                                    <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="id-<?php echo e($model->slug); ?>">
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('business-card-orders.ordersshow', $model->id)); ?>"
                                            ...
                                            <td width="100px">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-show')): ?>
                                                    <a href="<?php echo e(route('order.show', $model->id)); ?>" data-toggle="tooltip"
                                                ...
                                                <div class="btn-group mts-contacts-btn-group" role="group">
                                                    <?php if($model->phone): ?>
                                                        <button type="button"
                                                            ...
                                                            title="Send Text" data-name="<?php echo e($model->name); ?>"
                                                            data-last-name="<?php echo e($model->last_name ?? ''); ?>"
                                                            data-phone="<?php echo e($model->phone); ?>">
                                                    ...
                                                    <?php if($model->phone): ?>
                                                        <button type="button"
                                                            ...
                                                            title="Make Call (Twilio)" data-phone="<?php echo e($model->phone); ?>"
                                                            data-name="<?php echo e($model->name); ?> <?php echo e($model->last_name ?? ''); ?>">
                                                            <i class="fa fa-phone"></i>
                                                        </button>
                                                    <?php endif; ?>
                                                    <button type="button" class="btn btn-info btn-xs btn-open-email-modal"
                                                        title="Send Email" data-email="<?php echo e($model->email); ?>"
                                                        data-name="<?php echo e($model->name); ?> <?php echo e($model->last_name ?? ''); ?>">
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            Displying <?php echo e($models->firstItem()); ?> to <?php echo e($models->lastItem()); ?> of
                                            <?php echo e($models->total()); ?> records
