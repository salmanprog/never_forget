				...
				<div class="box box-info">
					<div class="box-body">
                        <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="Enter first name">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Enter last name">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="company" value="<?php echo e(old('company')); ?>" placeholder="Enter company">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="country" value="<?php echo e(old('country')); ?>" placeholder="Enter country">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="street" value="<?php echo e(old('street')); ?>" placeholder="Enter street">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="town" value="<?php echo e(old('town')); ?>" placeholder="Enter town">
                                <span style="color: red"><?php echo e($errors->first('town')); ?></span>
                            </div>
                        </div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Postcode<span style="color: red">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="postcode" value="<?php echo e(old('postcode')); ?>" placeholder="Enter postcode">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Enter phone">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter email">
