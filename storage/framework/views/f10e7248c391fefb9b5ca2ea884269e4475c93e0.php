                ...
                <div class="swiper-container-wrapper position-relative">
                    <div class="swiper mySwiper shop-nav-slider">
                        <ul class="nav nav-pills shop-nav swiper-wrapper" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item swiper-slide" role="presentation">
                                <button class="nav-link <?php echo e(request('category') == 'gusto' ? 'active' : ''); ?>"
                                    id="pills-gusto-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-gusto" type="button" role="tab"
                                    aria-controls="pills-gusto"
                                    aria-selected="<?php echo e(request('category') == 'gusto' ? 'true' : 'false'); ?>">Gusto</button>
                            </li>
                            <li class="nav-item swiper-slide" role="presentation">
                                <button
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade <?php echo e(!request('category') ? 'show active' : ''); ?>" id="pills-All"
                        ...
                        <div class="shop-total-products">
                            ...
                            <span class="shop-total-products__count"><?php echo e($products->count()); ?></span>
                        </div>
                        <div class="row" id="all-products">
                            <?php $__currentLoopData = $products->take($shopProductsPerPage); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-4 col-md-6 product-item visible" data-product-id="<?php echo e($product->id); ?>">
                    ...
                    <!-- Gusto Tab -->
                    <div class="tab-pane fade <?php echo e(request('category') == 'gusto' ? 'show active' : ''); ?>"
                        id="pills-gusto" role="tabpanel" aria-labelledby="pills-gusto-tab"
                        tabindex="0">
                        <div class="row">
                            <?php echo $__env->make('website.partials._gusto', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        let loading = false;
        const productsPerPage = <?php echo e((int) $shopProductsPerPage); ?>;
        let totalAllProducts = <?php echo e($products->count()); ?>;
        ...
        const productImageBase = <?php echo json_encode(asset('public/admin/assets/images/product'), 15, 512) ?>;
        const categoryMetaById = <?php echo json_encode($shopCategoryMeta ?? [], 15, 512) ?>;
        ...
        let activeCategory = normalizeCategoryKey(<?php echo json_encode(request('category') ?: 'all', 15, 512) ?>);
