...
<?php $__env->startSection('title', 'Business Card Order - Professional Print Services'); ?>
<style>
                ...
                <div class="col-lg-8">
                    <div class="order-card">
                        ...
                        <div class="order-card-body">
                            <form id="businessCardOrderForm" method="POST" action="<?php echo e(route('business-cards.order.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-section mb-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-3">
                                            ...
                                            ?>
                                            <div class="paper-option-card" data-value="<?php echo e($stock->option_key); ?>">
                                                <div class="card h-100 border-2 option-card" style="cursor: pointer;">
                                                    <div class="card-body text-center p-4">
                                                        <div class="paper-sample mb-3" style="background-color: <?php echo e($option['color']); ?>; height: 60px; border-radius: 8px; border: 2px solid #dee2e6;"></div>
                                                        <h5 class="card-title"><?php echo e($stock->name); ?></h5>
                                                        <p class="card-text small text-muted"><?php echo e($stock->description); ?></p>
                                                        <div class="price-info">
                                                            <?php if($stock->price_modifier > 0): ?>
                                                                <span class="text-success">+$<?php echo e(number_format($stock->price_modifier, 2)); ?>/card</span>
                                                            <?php else: ?>
                                                                <span class="text-success">Standard Price</span>
                                                            <?php endif; ?>
                                                        </div>
                                                        <input type="radio" name="paper_stock" value="<?php echo e($stock->option_key); ?>" class="d-none" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <select class="form-select form-select-lg" name="quantity" id="quantitySelect" required>
                                                ...
                                                <option value="<?php echo e($qty['value']); ?>" data-price="<?php echo e($qty['label']); ?>">
                                                    <?php echo e($qty['label']); ?>
                                ...
                                <div class="form-section mb-5">
                                    <div class="alert alert-warning">
                                        ...
                                        <a href="<?php echo e(route('contact-us')); ?>" class="btn btn-warning">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    paymentForm.addEventListener('submit', async function(event) {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("business-cards.create-payment-intent")); ?>', {
                method: 'POST',
                headers: {
    ...
    function submitOrderWithPayment(paymentIntentId) {
        ...
        // Submit order
        fetch('<?php echo e(route("business-cards.order.store")); ?>', {
            method: 'POST',
            body: formData
        })
    ...
    function updateOrderSummary() {
        ...
        if (quantity == 50000) {
            ...
            addToCartBtn.onclick = function() {
                window.location.href = '<?php echo e(route("contact-us")); ?>';
            };
        } else {
