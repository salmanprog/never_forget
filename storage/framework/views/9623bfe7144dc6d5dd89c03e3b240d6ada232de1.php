					...
					<div class="box-body">
						...
						<div class="form-group">
                            ...
                            <?php if(!empty($model->image)): ?>
                                <div class="col-sm-4">
                                    <img style="width: 80px" src="<?php echo e(asset('public/admin/assets/images/categories')); ?>/<?php echo e($model->image); ?>" alt="">
                                </div>
                            <?php else: ?>
                                <div class="col-sm-4" >
