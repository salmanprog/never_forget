<?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr id="id-<?php echo e($model->id); ?>">
        ...
        <td>
            <?php if($model->image): ?>
                <img src="<?php echo e(asset('public/admin/assets/images/business_card_categories/'.$model->image)); ?>" alt="" style="width:60px;">
            <?php else: ?>
...
<?php /**PATH D:\xamp-new\htdocs\never-forget\resources\views\admin\business_card_category\search.blade.php ENDPATH**/ ?>