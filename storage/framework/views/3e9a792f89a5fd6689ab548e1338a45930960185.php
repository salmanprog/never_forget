...
<input type="hidden" id="page_url" value="<?php echo e(route('phone-script-templates.index')); ?>">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">NEVER FORGET – 30-Day Phone Script Templates</h3>
                    <p class="text-muted" style="margin: 8px 0 0; font-size: 13px;">(Use these depending on the stage. Each call = 2-3 minutes.)</p>
                </div>
                <div class="box-body">
                    <div class="row">
                        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-3 col-sm-6 col-xs-12" style="margin-bottom: 20px;">
                                <a href="<?php echo e(route('phone-script-templates.show', $template['day'])); ?>" class="phone-script-card" style="text-decoration: none; color: inherit; display: block;">
