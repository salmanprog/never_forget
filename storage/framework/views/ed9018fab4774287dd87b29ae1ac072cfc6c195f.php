...
<?php $__env->startSection('title', 'Edit Business Card - Professional Printing Service'); ?>
<style>
                ...
                <div class="col-lg-6">
                    <div class="contact-form-container">
                        <form id="business-card-order-form" class="form-horizontal" method="POST"
                            action="<?php echo e(route('business-cards.update', $businessCard)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="field-wrapper mb-3">
                                            ...
                                            <input class="input-field" type="text" name="name"
                                                id="name" placeholder="Enter your full name" value="<?php echo e(old('name', $businessCard->name)); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <input class="input-field" type="text" name="job_title" id="job_title"
                                                placeholder="Manager, CEO, Designer, etc." value="<?php echo e(old('job_title', $businessCard->job_title)); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <input class="input-field" type="text" name="company" id="company"
                                                placeholder="Your Company" value="<?php echo e(old('company', $businessCard->company)); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <input class="input-field" type="tel" name="phone"
                                                id="phone" placeholder="+1 (555) 123-4567" value="<?php echo e(old('phone', $businessCard->phone)); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label for="email" class="label-field">Email Address <span
                                            ...
                                            <input class="input-field" type="email" name="email"
                                                id="email" placeholder="your.email@company.com" value="<?php echo e(old('email', $businessCard->email)); ?>">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <select class="input-field form-select modern-select" name="font_family_select"
                                                ...
                                                <option value="Arial" <?php echo e($businessCard->text_font == 'Arial' ? 'selected' : ''); ?>>Arial</option>
                                                <option value="Verdana" <?php echo e($businessCard->text_font == 'Verdana' ? 'selected' : ''); ?>>Verdana</option>
                                                <option value="Tahoma" <?php echo e($businessCard->text_font == 'Tahoma' ? 'selected' : ''); ?>>Tahoma</option>
                                                <option value="Trebuchet MS" <?php echo e($businessCard->text_font == 'Trebuchet MS' ? 'selected' : ''); ?>>Trebuchet MS</option>
                                                <option value="Georgia" <?php echo e($businessCard->text_font == 'Georgia' ? 'selected' : ''); ?>>Georgia</option>
                                                <option value="Times New Roman" <?php echo e($businessCard->text_font == 'Times New Roman' ? 'selected' : ''); ?>>Times New Roman</option>
                                                <option value="Courier New" <?php echo e($businessCard->text_font == 'Courier New' ? 'selected' : ''); ?>>Courier New</option>
                                                <option value="Lucida Console" <?php echo e($businessCard->text_font == 'Lucida Console' ? 'selected' : ''); ?>>Lucida Console</option>
                                                <option value="Comic Sans MS" <?php echo e($businessCard->text_font == 'Comic Sans MS' ? 'selected' : ''); ?>>Comic Sans MS</option>
                                                <option value="Impact" <?php echo e($businessCard->text_font == 'Impact' ? 'selected' : ''); ?>>Impact</option>
                                                <option value="Palatino Linotype" <?php echo e($businessCard->text_font == 'Palatino Linotype' ? 'selected' : ''); ?>>Palatino Linotype</option>
                                                <option value="Segoe UI" <?php echo e($businessCard->text_font == 'Segoe UI' ? 'selected' : ''); ?>>Segoe UI</option>
                                                <option value="Candara" <?php echo e($businessCard->text_font == 'Candara' ? 'selected' : ''); ?>>Candara</option>
                                                <option value="Garamond" <?php echo e($businessCard->text_font == 'Garamond' ? 'selected' : ''); ?>>Garamond</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <select class="input-field form-select modern-select" name="card_shape"
                                                ...
                                                <option value="standard" <?php echo e($businessCard->card_shape == 'standard' ? 'selected' : ''); ?>>Standard</option>
                                                <option value="square" <?php echo e($businessCard->card_shape == 'square' ? 'selected' : ''); ?>>Square</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <select class="input-field form-select modern-select" name="card_orientation"
                                                ...
                                                <option value="horizontal" <?php echo e($businessCard->card_orientation == 'horizontal' ? 'selected' : ''); ?>>Horizontal</option>
                                                <option value="vertical" <?php echo e($businessCard->card_orientation == 'vertical' ? 'selected' : ''); ?>>Vertical</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label for="email" class="label-field">Text Alignment<span
                                            class="text-danger">*</span></label>
                                            <button type="button" id="align-left" class="align-btn <?php echo e($businessCard->text_alignment == 'left' ? 'active' : ''); ?>" data-align="left">🡰</button>
                                            <button type="button" id="align-center" class="align-btn <?php echo e($businessCard->text_alignment == 'center' ? 'active' : ''); ?>" data-align="center">⭯</button>
                                            <button type="button" id="align-right" class="align-btn <?php echo e($businessCard->text_alignment == 'right' ? 'active' : ''); ?>" data-align="right">🡲</button>
                                        </div>
                                        <input type="hidden" name="text_alignment" id="text_alignment" value="<?php echo e($businessCard->text_alignment); ?>">
                                    </div> 
                                    <div class="col-lg-12">
                                        <div class="field-wrapper">
                                            ...
                                            <textarea class="input-field text-area" name="address" id="address" rows="2"
                                                placeholder="Enter your business address"><?php echo e(old('address', $businessCard->address)); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <select class="input-field form-select modern-select" name="paper_stock"
                                        ...
                                        <option value="matte" data-price="25" <?php echo e($latestOrder->paper_stock == 'matte' ? 'selected' : ''); ?>>Matte - Professional finish, no glare ($25/100 cards)</option>
                                        <option value="glossy" data-price="30" <?php echo e($latestOrder->paper_stock == 'glossy' ? 'selected' : ''); ?>>Glossy - High-gloss finish, vibrant colors ($30/100 cards)</option>
                                        <option value="premium" data-price="45" <?php echo e($latestOrder->paper_stock == 'premium' ? 'selected' : ''); ?>>Premium - Thick card stock, luxury feel ($45/100 cards)</option>
                                        <option value="kraft" data-price="35" <?php echo e($latestOrder->paper_stock == 'kraft' ? 'selected' : ''); ?>>Kraft - Eco-friendly, natural finish ($35/100 cards)</option>
                                        <option value="plastic" data-price="53" <?php echo e($latestOrder->paper_stock == 'plastic' ? 'selected' : ''); ?>>Plastic - Plastic finish ($53/100 cards)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <select class="input-field form-select modern-select" name="corner_style"
                                        ...
                                        <option value="standard" <?php echo e($latestOrder->corner_style == 'standard' ? 'selected' : ''); ?>>Standard - Sharp, square corners</option>
                                        <option value="rounded" <?php echo e($latestOrder->corner_style == 'rounded' ? 'selected' : ''); ?>>Rounded - Smooth, rounded corners (+$0.02/card)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <select class="input-field form-select modern-select" name="quantity"
                                        ...
                                        <option value="50" <?php echo e($latestOrder->quantity == '50' ? 'selected' : ''); ?>>50 cards</option>
                                        <option value="100" <?php echo e($latestOrder->quantity == '100' ? 'selected' : ''); ?>>100 cards</option>
                                        <option value="200" <?php echo e($latestOrder->quantity == '200' ? 'selected' : ''); ?>>200 cards</option>
                                        <option value="500" <?php echo e($latestOrder->quantity == '500' ? 'selected' : ''); ?>>500 cards</option>
                                        <option value="1000" <?php echo e($latestOrder->quantity == '1000' ? 'selected' : ''); ?>>1,000 cards</option>
                                        <option value="2000" <?php echo e($latestOrder->quantity == '2000' ? 'selected' : ''); ?>>2,000 cards</option>
                                        <option value="5000" <?php echo e($latestOrder->quantity == '5000' ? 'selected' : ''); ?>>5,000 cards</option>
                                        <option value="10000" <?php echo e($latestOrder->quantity == '10000' ? 'selected' : ''); ?>>10,000 cards</option>
                                        <option value="15000" <?php echo e($latestOrder->quantity == '15000' ? 'selected' : ''); ?>>15,000 cards</option> 
                                        <option value="custom" <?php echo e($latestOrder->quantity == 'custom' ? 'selected' : ''); ?>>Custom Quantity (15,000+)</option>
                                    </select>
                                </div>
                                ...
                                <div class="field-wrapper mt-3" id="custom-quantity-field" style="display: none;">
                                    ...
                                    <select class="input-field form-select modern-select" name="custom_quantity" id="custom_quantity_select">
                                        ...
                                        <option value="20000" <?php echo e($latestOrder->quantity == '20000' ? 'selected' : ''); ?>>20,000 cards</option>
                                        <option value="25000" <?php echo e($latestOrder->quantity == '25000' ? 'selected' : ''); ?>>25,000 cards</option>
                                        <option value="30000" <?php echo e($latestOrder->quantity == '30000' ? 'selected' : ''); ?>>30,000 cards</option>
                                        <option value="35000" <?php echo e($latestOrder->quantity == '35000' ? 'selected' : ''); ?>>35,000 cards</option>
                                        <option value="40000" <?php echo e($latestOrder->quantity == '40000' ? 'selected' : ''); ?>>40,000 cards</option>
                                        <option value="45000" <?php echo e($latestOrder->quantity == '45000' ? 'selected' : ''); ?>>45,000 cards</option>
                                        <option value="50000" <?php echo e($latestOrder->quantity == '50000' ? 'selected' : ''); ?>>50,000 cards</option>
                                    </select>
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="custom-design-section">
                                    ...
                                    <button type="button" class="custom-design-btn" onclick="window.location.href='<?php echo e(route('contact-us')); ?>'">
                                        ...
                                        <div class="col-md-6">
                                            <div class="color-group">
                                                ...
                                                <div class="color-picker-wrapper">
                                                    <input type="color" id="text-color" name="text_color" value="<?php echo e($latestOrder->text_color); ?>" class="color-picker"> 
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="color-group">
                                                ...
                                                <div class="color-picker-wrapper">
                                                    <input type="color" id="background-color" name="background_color"
                                                        value="<?php echo e($latestOrder->background_color); ?>" class="color-picker">
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <textarea class="input-field text-area" name="notes" id="notes" rows="3"
                                        placeholder="Enter any special requirements..."><?php echo e($latestOrder->notes); ?></textarea>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('cart')); ?>" class="btn btn-primary">Go to Cart</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let currentSelection = {
                ...
                // Contact information
                fullName: "<?php echo e(old('name', $businessCard->name)); ?>",
                email: "<?php echo e(old('name', $businessCard->email)); ?>",
                phone: "<?php echo e(old('name', $businessCard->phone)); ?>",
                company: "<?php echo e(old('name', $businessCard->company)); ?>",
                jobTitle: "<?php echo e(old('job_title', $businessCard->job_title)); ?>",
                address: "<?php echo e(old('address', $businessCard->address)); ?>",
                fontFamily: "<?php echo e($businessCard->text_font); ?>",
                textAlign: "<?php echo e($businessCard->text_alignment); ?>"
            };
            
            if (currentSelection.frontDesignFile) {
                urlToFile(
                    currentSelection.frontDesignFile,
                    "<?php echo e(basename($businessCard->card_front_image)); ?>",
                    'image/png'
                ).then(file => {
                    if (file) {
            ...
            if (currentSelection.backDesignFile) {
                urlToFile(
                    ...
                    "<?php echo e(basename($businessCard->card_back_image)); ?>",
                    'image/png'
                ).then(file => {
                    if (file) {
