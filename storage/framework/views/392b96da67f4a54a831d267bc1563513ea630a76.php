                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="user-footer">
                            <div>
                                <a href="<?php echo e(route('salesperson.profile.edit')); ?>" class="btn btn-default btn-flat" >Edit Profile</a>
                            </div>
                            <div>
...
</style><?php /**PATH D:\xamp-new\htdocs\never-forget\resources\views\layouts\sales-person\header.blade.php ENDPATH**/ ?>