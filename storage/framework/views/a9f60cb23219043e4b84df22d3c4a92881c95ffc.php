...
<?php $__env->startSection('title', 'Add New Occasion'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="title" id="title" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $occasionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('title') == $key ? 'selected' : ''); ?>>
                                        <?php echo e($value); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="occasion_date" id="occasion_date" 
                                   class="form-control" value="<?php echo e(old('occasion_date')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" class="form-control" rows="3" 
                                      placeholder="Add any additional notes about this occasion"><?php echo e(old('notes')); ?></textarea>
