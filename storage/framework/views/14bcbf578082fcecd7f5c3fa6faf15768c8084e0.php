...
<tr class="enquiry-summary-row">
    ...
    <td>
        <button type="button" class="btn btn-xs btn-default btn-toggle-enquiry-detail" data-target="quality-logo-detail-<?php echo e($enquiry->id); ?>" aria-expanded="false">
            <i class="fa fa-chevron-down"></i> View details
        </button>
    </td>
</tr>
<tr class="enquiry-detail-row" id="quality-logo-detail-<?php echo e($enquiry->id); ?>" style="display: none;">
        ...
        <div class="p-3">
            ...
            <table class="table table-bordered table-condensed mt-2 mb-0">
                <tbody>
                    ...
                    <?php endif; ?>
                    <?php if(!empty($enquiry->product_name)): ?>
                        <tr><th width="180">Product</th><td><?php echo e($enquiry->product_name); ?></td></tr>
                    <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\never-forget\resources\views/website/individual-dashboard/quality-logo-enquiries-partials/table.blade.php ENDPATH**/ ?>