					...
					<div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6" style="padding-top:5px">
                                <input type="file" class="form-control" accept="image*"  name="image" value="<?php echo isset($page_data['image'])?$page_data['image']:''; ?> id="image">
