...
<?php $__env->startSection('title', 'Business Cards - Professional Design & Printing'); ?>
        ...
        <div class="container mx-auto px-4">
            <div class="text-center text-white">
                ...
                <div class="flex flex-col md:flex-row gap-4 justify-center items-center mb-12">
                    <a href="<?php echo e(route('business-cards.create')); ?>" 
                    ...
                    <a href="<?php echo e(route('business-cards.order')); ?>" 
