...
<style> 
    ...
    #emailModal .modal-content { border: 1px solid #cfa40c; border-radius: 4px; box-shadow: 0 5px 15px rgba(8, 30, 55, 0.3); }
    #emailModal .modal-header { background-color: #081e37; color: #fff; border-bottom: 2px solid #cfa40c; padding: 12px 15px; display: flex; }
    #emailModal .modal-title { color: #cfa40c !important; font-weight: 600; }
    #emailModal .modal-header .close { color: #fff; opacity: 0.9; text-shadow: none; margin-left: auto; }
    #emailModal .modal-header .close:hover { color: #cfa40c; opacity: 1; }
    #emailModal .modal-body { background-color: #f4f4f4; padding: 20px; }
    #emailModal .modal-body label { color: #081e37; font-weight: 600; }
    #emailModal .modal-body .form-control { border: 1px solid #ddd; border-radius: 4px; }
    #emailModal .modal-body .form-control:focus { border-color: #cfa40c; box-shadow: 0 0 0 0.2rem rgba(207, 164, 12, 0.25); }
    #emailModal .modal-footer { background-color: #fff; border-top: 2px solid #cfa40c; padding: 12px 15px; }
    #emailModal .modal-footer .btn-secondary { background-color: #6c757d; border-color: #6c757d; color: #fff; }
    #emailModal .modal-footer #emailModalSendBtn { background-color: #081e37; border-color: #cfa40c; color: #fff; }
    #emailModal .modal-footer #emailModalSendBtn:hover { background-color: #cfa40c; border-color: #cfa40c; color: #081e37; }
</style>
