            ...
            <tr align="center">
				...
				<td>
					<?php if($order_detail->hasProduct?->image): ?>
						<img  src="<?php echo e(public_path('admin/assets/images/product/' . $order_detail->hasProduct->image)); ?>" alt="Preview" style="height:70px; width:70px">
					<?php else: ?>
						<img src="<?php echo e(public_path('admin/assets/images/product/no-photo1.jpg')); ?>" alt="Preview" style="height:70px; width:70px">
					<?php endif; ?>
				</td>
                <td>$<?php echo e(number_format ($order_detail->price??'00', 2)); ?></td>
                <td>
                    <?php if(isset($order_detail->hasProduct)): ?>
                        <?php echo e($order_detail->hasProduct->product_type == 1 ? 'Variable Product' : 'Simple Product'); ?>
...
<?php /**PATH D:\xamp-new\htdocs\never-forget\resources\views\admin\order\myPDF.blade.php ENDPATH**/ ?>