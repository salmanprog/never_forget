...
<section class="content-header">
    ...
    <div class="content-header-right">
        ...
        <a href="<?php echo e(route('phone-script-templates.index')); ?>" class="btn btn-primary btn-sm">All templates</a>
    </div>
</section>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="input-group" style="display: block;">
                            <textarea class="form-control" style="margin-bottom: 10px; resize: vertical;" id="scriptBody" rows="6" readonly><?php echo e($template['body']); ?></textarea>
