            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-60" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                        <?php echo e($home_page_data['contact_heading']); ?>

                    </p>
                </div>
                <div class="col-lg-12">
                    <div class="contact-form-container">
                        <?php if(session('contactmessage')): ?>
                            <div id="success-message-contact" class="alert alert-success" role="alert">
                                <?php echo e(session('contactmessage')); ?></div>
                            <script>
                                setTimeout(function() {
            ...
            <div class="row row-gap-40 text-center text-lg-start">
                <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    <div class="img-wrapper position-relative">
                        <img src="<?php echo e(asset('public/admin/assets/images/page')); ?>/<?php echo e($home_page_data['why_contact_us_image']); ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    ...
                    <h2 class="heading fs-74 mb-30"><?php echo $home_page_data['why_contact_us_heading']; ?></h2>
                    <div class="mb-30">
                        <h4 class="fs-28 mb-10 fw-600 text-primary-theme-light"><?php echo $home_page_data['title_one']; ?></h4>
                        <p> 
                            <?php echo $home_page_data['description_one']; ?>

                        </p>
                    </div>
                    <div class="mb-30">
                        <h4 class="fs-28 mb-10 fw-600 text-primary-theme-light"><?php echo $home_page_data['title_two']; ?></h4>
                        <p>
                            <?php echo $home_page_data['description_two']; ?>

                        </p>
                    </div>
                    <div class="mb-30">
                        <h4 class="fs-28 mb-10 fw-600 text-primary-theme-light"><?php echo $home_page_data['title_three']; ?></h4>
                        <p>
                            <?php echo $home_page_data['description_three']; ?>

                        </p>
                    </div>
                    <div class="mb-30">
                        <h4 class="fs-28 mb-10 fw-600 text-primary-theme-light"><?php echo $home_page_data['title_four']; ?></h4>
                        <p>
                            <?php echo $home_page_data['description_four']; ?>
        ...
        <div class="container">
            <div class="row row-gap-40 text-center text-lg-start flex-column-reverse flex-lg-row">
                <div class="col-lg-6" data-aos="fade-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    ...
                    <a href="tel:<?php echo e($home_page_data['contact_phone']); ?>"
                        ...
                        <span class="fs-28 fw-600 light-black "><?php echo e($home_page_data['contact_phone']); ?></span>
                    </a>
                    <a href="mailto:<?php echo e($home_page_data['contact_email']); ?>"
                        class="gap-20 mb-40 d-flex align-items-center text-white sm-circle-wrapper">
                        <div class="sm-circle d-flex align-items-center justify-content-center">
                            <i class="fa-solid fa-envelope"></i>
                        </div>
                        <span class="text-black fs-28 fw-600"><?php echo e($home_page_data['contact_email']); ?></span>
                    </a>
                    <div class="mb-40">
                        <span class="fw-600 fs-32 light-black">Follow Us On:</span>
                    </div>
                    <ul class="social-links d-flex align-items-center gap-20">
                        <?php if(!empty($home_page_data['contact_facebook'])): ?>
                            <li><a href="<?php echo e($home_page_data['contact_facebook']); ?>"><i class="fa-brands fa-facebook-f"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($home_page_data['contact_instagram'])): ?>
                            <li><a href="<?php echo e($home_page_data['contact_instagram']); ?>"><i class="fa-brands fa-instagram"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($home_page_data['contact_twitter'])): ?>
                            <li><a href="<?php echo e($home_page_data['contact_twitter']); ?>"><i class="fa-brands fa-x-twitter"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($home_page_data['contact_linkedin'])): ?>
                            <li><a href="<?php echo e($home_page_data['contact_linkedin']); ?>"><i class="fa-brands fa-linkedin-in"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($home_page_data['contact_tiktok'])): ?>
                            <li><a href="<?php echo e($home_page_data['contact_tiktok']); ?>"><i class="fa-brands fa-tiktok"></i></a></li>
                        <?php endif; ?>
                        <?php if(!empty($home_page_data['contact_pinterest'])): ?>
                            <li><a href="<?php echo e($home_page_data['contact_pinterest']); ?>"><i class="fa-brands fa-pinterest"></i></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div class="col-lg-6" data-aos="fade-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    <div class="img-wrapper position-relative">
                        <img src="<?php echo e(asset('public/admin/assets/images/page')); ?>/<?php echo e($home_page_data['contact_us_image']); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
