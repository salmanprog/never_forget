    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('user.profile.update')); ?>" id="regform" class="form-horizontal"
