				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="hidden" class="form-control" value="<?php echo e(optional($salesperson_roles->first())->name ?? 'Sales Person'); ?>" name="account_type" readonly>
							</div>
						</div>
						<div class="form-group">
