...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-20 justify-content-end">
                                        <a href="<?php echo e(route('shop', ['category' => 'balloons'])); ?>" class="golbal-btn-submit" id="balloon-add-more-btn">
                                            Add More
                                        </a>
                                        <button type="submit" class="golbal-btn-submit btn-submit"
...
<script>
    $(document).ready(function() {
        var formStorageKey = 'balloon_enquiry_form';
        ...
        if ($form.length) {
            ...
            $('#balloon-add-more-btn').on('click', function(e) {
                e.preventDefault();
        ...
        $('.enquiry-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    try { sessionStorage.removeItem('balloon_enquiry_form'); } catch (e) {}
                    Swal.fire({
                        icon: 'success',
                        title: 'Thank You!',
                ...
                complete: function() {
                    $('.btn-submit').prop('disabled', false).text('Submit Balloon Enquiry');
                },
                error: function(xhr) {
