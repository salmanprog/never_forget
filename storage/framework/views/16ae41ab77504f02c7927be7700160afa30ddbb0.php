...
<input type="hidden" id="page_url" value="<?php echo e(route('about_us.index')); ?>">
								...
								<tr id="id-<?php echo e($model->id); ?>">
                                    ...
                                    <td>
										<?php if($model->first_image): ?>
											<img src="<?php echo e(asset('public/admin/assets/images/about_us/'.$model->first_image)); ?>" alt="" style="width:80px;">
										<?php else: ?>
											<img src="<?php echo e(asset('public/admin/assets/images/default.jpg')); ?>" style="width:80px;">
										<?php endif; ?>
									</td>
                                    <td>
										<?php if($model->second_image): ?>
											<img src="<?php echo e(asset('public/admin/assets/images/about_us/'.$model->second_image)); ?>" alt="" style="width:80px;">
										<?php else: ?>
											<img src="<?php echo e(asset('public/admin/assets/images/default.jpg')); ?>" style="width:80px;">
										<?php endif; ?>
									</td>
