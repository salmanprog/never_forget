                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <th>Name</th>
                                <td><?php echo e(optional($model->hasCustomer)->first_name ?? ''); ?> <?php echo e(optional($model->hasCustomer)->last_name ?? 'Not Provided'); ?></td>
                            </tr>
                            <tr>
                                <th>Email</th>
                                <td><?php echo e(optional($model->hasCustomer)->email ?? 'Not Provided'); ?></td>
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <td><?php echo e(optional($model->hasCustomer)->phone ?? 'Not Provided'); ?></td>
                            </tr>
                            <tr>
                                <th>Address</th>
                                <td>
