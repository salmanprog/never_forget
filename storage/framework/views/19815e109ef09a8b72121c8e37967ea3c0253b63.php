...
<section class="content-header">
    ...
    <div class="content-header-right">
        ...
        <a href="<?php echo e(route('templates.index')); ?>" class="btn btn-primary btn-sm" style="color: white;"><i class="fa fa-arrow-left"></i> <span class="ml-2">Back to Templates</span></a>
    </div>
</section>
