				...
				<div class="box box-info">
					<div class="box-body"> 
						<div class="form-group">
							...
							<?php if(isset($page_data['how_it_works_video'])): ?>
							<div class="col-sm-4">
								<video id="video_preview" style="width: 250px;" controls>
									<source src="<?php echo e(asset('public/admin/assets/videos/'.$page_data['how_it_works_video'])); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select name="how_it_works_status" class="form-control select2 select2-accessible" style="width:auto;" tabindex="-1" aria-hidden="true">
									<option value="1" <?php echo e((isset($page_data['how_it_works_status'])?($page_data['how_it_works_status']==1?'selected':''):'')); ?>>Show</option>
									<option value="0" <?php echo e((isset($page_data['how_it_works_status'])?($page_data['how_it_works_status']==0?'selected':''):'')); ?>>Hide</option>
								</select>
							</div>
						</div>
