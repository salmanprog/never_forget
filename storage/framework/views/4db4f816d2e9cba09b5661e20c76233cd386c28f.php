						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<?php if(!empty($user->image)): ?>
									<img style="width: 80px; height: 80px; object-fit: cover; border-radius: 50%;" id="profile_picture_preview" src="<?php echo e(asset('public/admin/assets/images/UserImage')); ?>/<?php echo e($user->image); ?>" alt="Profile">
								<?php else: ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="billing_first_name" id="billing_first_name"
									value="<?php echo e(old('billing_first_name', $billingNameParts[0] ?? '')); ?>" placeholder="Enter first name">
								<span style="color: red"><?php echo e($errors->first('billing_first_name')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="billing_last_name" id="billing_last_name"
									value="<?php echo e(old('billing_last_name', $billingNameParts[1] ?? '')); ?>" placeholder="Enter last name">
								<span style="color: red"><?php echo e($errors->first('billing_last_name')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="billing_company" id="billing_company"
									value="<?php echo e(old('billing_company', $company->name ?? '')); ?>" placeholder="Enter company">
								<span style="color: red"><?php echo e($errors->first('billing_company')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="billing_country" id="billing_country"
									value="<?php echo e(old('billing_country', $company->billing_country ?? '')); ?>" placeholder="Enter country">
								<span style="color: red"><?php echo e($errors->first('billing_country')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="billing_address_line_1" id="billing_street"
									value="<?php echo e(old('billing_address_line_1', $company->billing_address_line_1 ?? '')); ?>" placeholder="Start typing address">
								<span style="color: red"><?php echo e($errors->first('billing_address_line_1')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="billing_state" id="billing_state"
									value="<?php echo e(old('billing_state', $company->state ?? '')); ?>" placeholder="Enter State">
								<span style="color: red"><?php echo e($errors->first('billing_state')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="billing_city" id="billing_town"
									value="<?php echo e(old('billing_city', $company->city ?? '')); ?>" placeholder="Enter town">
								<span style="color: red"><?php echo e($errors->first('billing_city')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="billing_zip_code" id="billing_postcode"
									value="<?php echo e(old('billing_zip_code', $company->zip_code ?? '')); ?>" placeholder="Enter postcode">
								<span style="color: red"><?php echo e($errors->first('billing_zip_code')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="tel" autocomplete="off" class="form-control" name="billing_phone" id="billing_phone"
									value="<?php echo e(old('billing_phone', $company->billing_phone ?? '')); ?>" placeholder="Enter phone">
								<span style="color: red"><?php echo e($errors->first('billing_phone')); ?></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email" autocomplete="off" class="form-control" name="billing_email" id="billing_email"
									value="<?php echo e(old('billing_email', $company->billing_email ?? '')); ?>" placeholder="Enter email">
								<span style="color: red"><?php echo e($errors->first('billing_email')); ?></span>
							</div>
						</div>
						<hr class="col-sm-11" style="margin: 20px 0; border-color: #cfa40c;">
