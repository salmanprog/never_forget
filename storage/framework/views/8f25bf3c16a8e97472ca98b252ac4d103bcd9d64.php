        ...
        <ul class="sidebar-menu admin">
            ...
            <li class="treeview <?php echo e(request()->is('page') ||request()->is('page/*') ||request()->is('page_setting/*') ||request()->is('variations') ||request()->is('variations/*') ||request()->is('product') ||request()->is('product/*') ||request()->is('category') ||request()->is('category/*') ||request()->is('order') ||request()->is('order/*') ||request()->is('coupon') ||request()->is('coupon/*') ||request()->is('collaborator') ||request()->is('collaborator/*') ||request()->is('testimonial') ||request()->is('testimonial/*') ||request()->is('careers') ||request()->is('careers/*') ||request()->is('career_category') ||request()->is('career_category/*') ||request()->is('business_card_options') ||request()->is('business_card_options/*') ||request()->is('business_card_categories') ||request()->is('business_card_categories/*') ||request()->is('business_card_templates') ||request()->is('business_card_templates/*') ||request()->is('business_card') ||request()->is('business_card/*') ||request()->is('newsletter') ||request()->is('newsletter/*') ||request()->is('faq') ||request()->is('faq/*') ||request()->is('why_choose_us') ||request()->is('why_choose_us/*') ||request()->is('balloons_category*') ||request()->is('perfect_gift_category*') ||request()->is('e_card_category*') ||request()->is('tango_category*')? 'active': ''); ?>"
                ...
                <ul class="treeview-menu"
                    ...
                    <?php endif; ?>
                    <li class="treeview">
                        <a href="<?php echo e(route('admin.package_setting.index')); ?>"
                            class="<?php echo e(request()->is('package-settings') ? 'active' : ''); ?>">
            ...
            <li class="treeview <?php echo e(request()->is('contactus') || request()->is('contactus/create') || request()->is('contactus/*/show') || request()->is('contactus/*/edit') || request()->is('contactus/*') ||request()->is('user') ||request()->is('user/*') || request()->is('mts-dashboard*') || request()->is('templates') || request()->is('templates/*') || request()->is('email-templates') || request()->is('email-templates/*') || request()->is('text-message-templates') || request()->is('text-message-templates/*') || request()->is('phone-script-templates') || request()->is('phone-script-templates/*') || request()->is('balloon_enquiry') || request()->is('balloon_enquiry/create') || request()->is('balloon_enquiry/*/show') || request()->is('balloon_enquiry/*/edit') || request()->is('balloon_enquiry/*') || request()->is('perfect_gift_enquiry') || request()->is('perfect_gift_enquiry/*') || request()->is('e_card_enquiry') || request()->is('e_card_enquiry/*') || request()->is('greetings_appreciation_enquiry') || request()->is('greetings_appreciation_enquiry/*') || request()->is('enquires/journey_expert/*') || request()->is('enquires/quality_logo') || request()->is('business-card-orders') ? 'active': ''); ?>">
                ...
                <ul class="treeview-menu" style="display: <?php echo e(request()->is('mts-dashboard*') || request()->is('templates') || request()->is('templates/*') || request()->is('email-templates') || request()->is('email-templates/*') || request()->is('text-message-templates') || request()->is('text-message-templates/*') || request()->is('phone-script-templates') || request()->is('phone-script-templates/*') || request()->is('contactus') || request()->is('contactus/create') || request()->is('contactus/*/show') || request()->is('contactus/*/edit') || request()->is('contactus/*') ||request()->is('user') ||request()->is('user/*') || request()->is('balloon_enquiry') || request()->is('balloon_enquiry/create') || request()->is('balloon_enquiry/*/edit') || request()->is('balloon_enquiry/*/show') || request()->is('perfect_gift_enquiry') || request()->is('perfect_gift_enquiry/*') || request()->is('e_card_enquiry') || request()->is('e_card_enquiry/*') || request()->is('greetings_appreciation_enquiry') || request()->is('greetings_appreciation_enquiry/*') || request()->is('enquires/journey_expert') || request()->is('enquires/quality_logo') || request()->is('business-card-orders')  ? 'block' : 'none'); ?>;">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contactus-list')): ?>
                        ...
                        <li class="treeview">
                            <a href="<?php echo e(route('templates.index')); ?>"
                                class="<?php echo e(request()->is('templates') || request()->is('templates/*') || request()->is('email-templates') || request()->is('email-templates/*') || request()->is('text-message-templates') || request()->is('text-message-templates/*') || request()->is('phone-script-templates') || request()->is('phone-script-templates/*') ? 'active' : ''); ?>">
                    ...
                    <li class="treeview">
                        <a href="<?php echo e(route('greetings_appreciation_enquiry.index')); ?>"
                        class="<?php echo e(request()->is('greetings_appreciation_enquiry') || request()->is('greetings_appreciation_enquiry/*') ? 'active' : ''); ?>">
