        ...
        <div class="card error-card">
            ...
            <div class="error-section">
                ...
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('index')); ?>" class="btn btn-primary">Visit Website</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary">Go to Login</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\xamp-new\htdocs\never-forget\resources\views\employee-invitation\invalid.blade.php ENDPATH**/ ?>