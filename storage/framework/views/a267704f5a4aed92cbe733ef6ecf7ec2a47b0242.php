        ...
        <section id="menu" class="menu section-bg-img">
            <div class="container aos-init aos-animate" data-aos="fade-up">
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        <ul id="menu-flters">
                            <?php if(!empty($subcategory)): ?>
                                <li data-filter="*" class="filter-active"><?php echo e($subcategory->title); ?></li>
                            <?php else: ?>
                                <li data-filter="*" class="filter-active">All <?php echo e($category->title); ?></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row menu-container aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" style="position: relative; height: 597.9px;">
                    <?php echo $__env->make('website.product-ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
