...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<?php endif; ?>
			<form action="<?php echo e(route('salesperson.profile.update')); ?>" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<?php echo csrf_field(); ?>
				...
				<div class="box box-info">
					<div class="box-body"> 
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" value="<?php echo e($user->first_name); ?>" name="first_name" placeholder="Enter First Name">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="address" value="<?php echo e($user->address); ?>" placeholder="Enter Address">
								<span style="color: red"><?php echo e($errors->first('address')); ?></span>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Phone Number<span style="color: red">*</span></label>
							<div class="col-sm-9">
								<input type="phone" autocomplete="off" class="form-control" name="phone" value="<?php echo e($user->phone); ?>" placeholder="Enter phone number">
