<?php $__env->startSection('title', 'Order Business Cards - Professional Printing Service'); ?>
<style>
        ...
        <section class="inner-banner">
            <div class="container">
                <h1 class="heading fs-74" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    Order Your <span>Business Cards</span></h1>
            </div>
        </section>
    </main>
                ...
                <div class="col-lg-6">
                    <div class="contact-form-container">
                        <form id="business-card-order-form" class="form-horizontal" method="post"
                            action="<?php echo e(route('business-cards.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="field-wrapper mb-3">
                                            <label for="name" class="label-field">Full Name <span
                                    ...
                                    <div class="col-lg-6">
                                        <div class="field-wrapper">
                                            ...
                                            <input class="input-field" type="text" name="job_title" id="job_title"
                                                placeholder="Manager, CEO, Designer, etc.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label for="email" class="label-field">Email Address <span
                                            ...
                                            <input class="input-field" type="email" name="email"
                                                id="email" placeholder="your.email@company.com">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label for="email" class="label-field">Text Alignment<span
                                            class="text-danger">*</span></label>
                                            <button type="button" id="align-left" class="align-btn active" data-align="left">🡰</button>
                                            <button type="button" id="align-center" class="align-btn" data-align="center">⭯</button>
                                            <button type="button" id="align-right" class="align-btn" data-align="right">🡲</button>
                                        </div>
                                        <input type="hidden" name="text_alignment" id="text_alignment" value="left">
                                    </div> 
                                    <div class="col-lg-12">
                                        <div class="field-wrapper">
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <select class="input-field form-select modern-select" name="paper_stock"
                                        ...
                                        <option value="matte" data-price="25">Matte - Professional finish, no glare ($25/100 cards)</option>
                                        <option value="glossy" data-price="30">Glossy - High-gloss finish, vibrant colors ($30/100 cards)</option>
                                        <option value="premium" data-price="45">Premium - Thick card stock, luxury feel ($45/100 cards)</option>
                                        <option value="kraft" data-price="35">Kraft - Eco-friendly, natural finish ($35/100 cards)</option>
                                        <option value="plastic" data-price="53">Plastic - Plastic finish ($53/100 cards)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <select class="input-field form-select modern-select" name="corner_style"
                                        ...
                                        <option value="standard">Standard - Sharp, square corners</option>
                                        <option value="rounded">Rounded - Smooth, rounded corners (+$0.02/card)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="order-section mb-5">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <select class="input-field form-select modern-select" name="quantity"
                                        ...
                                        <option value="15000">15,000 cards</option> 
                                        <option value="custom">Custom Quantity (15,000+)</option>
                                    </select>
                                </div>
                                ...
                                <div class="field-wrapper mt-3" id="custom-quantity-field" style="display: none;">
                                    ...
                                    <select class="input-field form-select modern-select" name="custom_quantity" id="custom_quantity_select">
                                        ...
                                        <option value="20000">20,000 cards</option>
                                        <option value="25000">25,000 cards</option>
                                        <option value="30000">30,000 cards</option>
                                        <option value="35000">35,000 cards</option>
                                        <option value="40000">40,000 cards</option>
                                        <option value="45000">45,000 cards</option>
                                        <option value="50000">50,000 cards</option>
                                    </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="color-group">
                                                ...
                                                <div class="color-picker-wrapper">
                                                    <input type="color" id="text-color" name="text_color" value="#333333" class="color-picker"> 
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let currentSelection = {
                ...
                cornerStyle: 'standard', // Default to standard corners
            ...
            function updatePreview() {
                ...
                console.log('currentPreviewType...',currentSelection.currentPreviewType);
