    ...
    <div class="content">
        ...
        <div class="info-box">
            <div class="info-row">
                ...
                <span class="value"><?php echo e($details['body']['first_name'] ?? ''); ?> <?php echo e($details['body']['last_name'] ?? ''); ?></span>
            </div>
            <div class="info-row">
                <span class="label">Email:</span>
                <span class="value"><?php echo e($details['body']['email'] ?? ''); ?></span>
            </div>
            <div class="info-row">
                <span class="label">Phone:</span>
                <span class="value"><?php echo e($details['body']['phone'] ?? ''); ?></span>
            </div>
        </div>

        <?php if(isset($details['body']['message']) && $details['body']['message'] && $details['body']['message'] != 'No additional message provided.'): ?>
        <div class="message-box">
            <p style="margin: 0 0 10px 0;"><strong>Additional Message:</strong></p>
            <p style="margin: 0; white-space: pre-wrap;"><?php echo e($details['body']['message']); ?></p>
        </div>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\never-forget\resources\views/emails/collaborate-quote.blade.php ENDPATH**/ ?>