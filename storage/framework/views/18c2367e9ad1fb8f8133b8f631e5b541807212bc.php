...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('admin.company.store')); ?>" id="company-form" class="form-horizontal" method="post" accept-charset="utf-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('name')); ?>" name="name" id="name" placeholder="Enter company name">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="url" class="form-control" value="<?php echo e(old('website')); ?>" name="website" id="website" placeholder="https://example.com">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address" id="address" rows="3" placeholder="Enter company address"><?php echo e(old('address')); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('industry')); ?>" name="industry" id="industry" placeholder="Enter industry">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" value="<?php echo e(old('billing_email')); ?>" name="billing_email" id="billing_email" placeholder="Enter billing email">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('billing_phone')); ?>" name="billing_phone" id="billing_phone" placeholder="Enter billing phone">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="options" id="options" class="form-control">
                                    <option value="Clientele" <?php echo e(old('options') == 'Clientele' ? 'selected' : ''); ?>>Clientele</option>
                                    <option value="Employees" <?php echo e(old('options') == 'Employees' ? 'selected' : ''); ?>>Employees</option>
                                    <option value="Both" <?php echo e(old('options') == 'Both' || old('options') == '' ? 'selected' : ''); ?>>Both</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="description" id="description" rows="4" placeholder="Enter company description"><?php echo e(old('description')); ?></textarea>
