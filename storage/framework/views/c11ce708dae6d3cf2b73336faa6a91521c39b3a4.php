...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo e(route('catering_service.update', $model->id)); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<?php echo csrf_field(); ?>
				...
				<div class="box box-info">
					<div class="box-body">
                        <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="first_title" value="<?php echo e($model->first_title); ?>">
							</div>
						</div>
                        <div class="form-group">
							<label for="" class="col-sm-2 control-label">Second Title <span style="color:red">*</span></label>
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="second_title" value="<?php echo e($model->second_title); ?>">
							</div>
						</div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 100px " src="<?php echo e(asset('public/admin/assets/images/catering')); ?>/<?php echo e($model->first_image); ?>" alt="">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                <img style="width: 100px " src="<?php echo e(asset('public/admin/assets/images/catering')); ?>/<?php echo e($model->second_image); ?>" alt="">
                            </div>
                        </div>
						<div class="form-group">
