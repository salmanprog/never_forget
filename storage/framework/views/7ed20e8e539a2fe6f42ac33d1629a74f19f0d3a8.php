    <footer class="footer">
        ...
        <div class="footer-bottom"> 
            <div class="d-flex justify-content-between align-items-center container">
                <h6 class="text-white mb-0">Copyright © <?php echo e(date('Y')); ?> Never Forget Showing Appreciation</h6>
                <h6 class="text-white mb-0"><?php echo $home_page_data['footer_copy_left']; ?></h6>
            </div>
        </div> 
    </footer>
<?php /**PATH D:\xamp-new\htdocs\neverforget-updated\resources\views/layouts/website/footer.blade.php ENDPATH**/ ?>