...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="<?php echo e(route('product.update', $details->slug)); ?>" id="regform"
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                                ...
                                <div class="col-md-9">
                                    <select name="category_id" id="category_id" class="form-control get_sub_category">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php echo e($details->category_id == $category->id ? 'selected' : ''); ?>><?php echo e($category->title); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="product_type" id="product_type" class="form-control">
                                        <option value="0" <?php echo e($details->product_type == 0 ? 'selected' : ''); ?>> Simple Product</option>
                                        <option value="1" <?php echo e($details->product_type == 1 ? 'selected' : ''); ?>> Variable Product</option>
                                    </select>
                                    <span style="color: red"><?php echo e($errors->first('product_type')); ?></span>
                                </div>
                            </div>
                            <div class="form-group" id="productPrice" style="display: <?php echo e($details->product_type == 0 ? 'block' : 'none'); ?>;">
                                <div class="col-md-2" style="text-align: end;">
                                    <label for="" class="control-label">Product Price</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" autocomplete="off" class="form-control" name="product_price"
                                        value="<?php echo e($details->product_price); ?>" placeholder="Enter product Price">
                                    <span style="color: red"><?php echo e($errors->first('product_price')); ?></span>
                                </div>
                            </div>

                            <div class="form-group" id="variablePrice" style="display: <?php echo e($details->product_type == 1 ? 'block' : 'none'); ?>;">
                                <div class="col-md-2" style="text-align: end;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" autocomplete="off" class="form-control" name="from_price"
                                                value="<?php echo e(json_decode($details->variation_price)->from ?? ''); ?>" placeholder="From Price">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" autocomplete="off" class="form-control" name="to_price"
                                                value="<?php echo e(json_decode($details->variation_price)->to ?? ''); ?>" placeholder="To Price">
                            ...
                            <div class="form-group" id="variationsSection" style="display: <?php echo e($details->product_type == 1 ? 'block' : 'none'); ?>;">
                                <label for="" class="col-sm-2 control-label">Variations</label>
                                <div class="col-sm-9">
                                    <table id="form-table" class="table">
                                        <tbody>
                                            <?php if(isset($product_variations) && count($product_variations) > 0): ?>
                                                <?php $__currentLoopData = $product_variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="form-row">
                                                    <td style="width:25%">
                                                        <select name="variation_id[]" class="form-control select2">
                                                            <option value="0" selected> Select Option</option>
                                                            <?php $__currentLoopData = $variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($var->id); ?>" <?php echo e($variation['variation_id'] == $var->id ? 'selected' : ''); ?>><?php echo e($var->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </td>
                                                    <td style="width:25%">
                                                        <input type="text" autocomplete="off" name="variation_price[]"
                                                            class="form-control" value="<?php echo e($variation['price']); ?>"
                                                        ...
                                                        <div class="variation-image-container">
                                                            <div class="variation-image-wrapper">
                                                                <img style="width: 80px; cursor: pointer;" class="variation-image-preview" 
                                                                    src="<?php echo e(isset($variation['image']) ? asset('public/admin/assets/images/product/variations') . '/' . $variation['image'] : asset('public/admin/assets/images/default.jpg')); ?>" 
                                                ...
                                                <tr class="form-row">
                                                    ...
                                                    <td style="width:30%">
                                                        <div class="variation-image-container">
                                                            <div class="variation-image-wrapper">
                                                                <img style="width: 80px; cursor: pointer;" class="variation-image-preview" 
                                                                    src="<?php echo e(asset('public/admin/assets/images/default.jpg')); ?>" 
                                                                    alt="Click to upload image">
                                                                <div class="variation-image-overlay">
                                                                    <i class="fa fa-upload"></i>
                                                                </div>
                                        ...
                                        <?php if($details->image): ?>
                                            <div class="image-container" style="position: relative; display: inline-block;">
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm remove-image" 
                                                    ...
                                                    data-image="<?php echo e($details->image); ?>" data-type="main">
                                                    <i class="fa fa-times"></i>
                                                </button>
                                            </div>
                                        <?php endif; ?>
                                        <?php if($details->related_images): ?>
                                            <?php $__currentLoopData = json_decode($details->related_images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="image-container" style="position: relative; display: inline-block;">
                                                    <img src="<?php echo e(asset('public/admin/assets/images/product')); ?>/<?php echo e($relatedImage); ?>" 
                                                        style="width: 80px; height: 80px; object-fit: cover; margin: 5px;" alt="Related Image">
                                                    <button type="button" class="btn btn-danger btn-sm remove-image" 
                                                        style="position: absolute; top: 0; right: 0; padding: 2px 5px;"
                                                        data-image="<?php echo e($relatedImage); ?>" data-type="related">
                                                        <i class="fa fa-times"></i>
                                                    </button>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control texteditor" name="description" style="height:200px;"><?php echo $details->description; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control texteditor" name="short_description" style="height:200px;"><?php echo $details->short_description; ?></textarea>
                                    ...
                                    <select name="related_product[]" id="related_product"
                                        ...
                                        <?php $__currentLoopData = $relateds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option data-select2-id="<?php echo e($related->id); ?>" value="<?php echo e($related->id); ?>"
                                                <?php echo e($selected); ?>><?php echo e($related->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control" id="">
                                        <option value="1" <?php echo e($details->status == 1 ? 'selected' : ''); ?>>Active
                                        </option>
                                        <option value="0" <?php echo e($details->status == 0 ? 'selected' : ''); ?>>In-Active
                                        </option>
                                    </select>
                                </div>
                            </div>
