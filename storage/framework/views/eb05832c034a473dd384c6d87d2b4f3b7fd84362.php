					...
					<div class="box-body">
                        <div class="form-group">
                            ...
                            <?php if(isset($page_data['header_favicon'])): ?>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <img src="<?php echo e(asset('public//public/admin/assets/images/page/'.$page_data['header_favicon'])); ?>" class="existing-photo" style="height:50px;">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="form-group">
                            ...
                            <?php if(isset($page_data['admin_header_logo'])): ?>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <img src="<?php echo e(asset('public//public/admin/assets/images/page/'.$page_data['admin_header_logo'])); ?>" class="existing-photo" style="height:50px;">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="form-group">
                            ...
                            <?php if(isset($page_data['header_logo'])): ?>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <img src="<?php echo e(asset('public//public/admin/assets/images/page/'.$page_data['header_logo'])); ?>" class="existing-photo" style="height:50px;">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-6">
								<input type="tel" name="header_phone" class="form-control" value="<?php echo e(isset($page_data['header_phone'])?$page_data['header_phone']:''); ?>" placeholder="Enter phone number">
							</div>
						</div> 
						<div class="form-group">
