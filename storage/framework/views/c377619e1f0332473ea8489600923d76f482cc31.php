        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-pills shop-nav" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-<?php echo e($category->id); ?>-tab" data-bs-toggle="pill" data-bs-target="#pills-<?php echo e($category->id); ?>" type="button" role="tab" aria-controls="pills-<?php echo e($category->id); ?>" aria-selected="false"><?php echo e($category->title); ?></button>
                    </li>
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-All" role="tabpanel" aria-labelledby="pills-All-tab" tabindex="0">
                        <div class="row" id="all-careers">
                            <?php $__currentLoopData = $all_careers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $career): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4 col-md-6 career-item visible">
                                <div class="career-card-wrapper">
                                    <?php if($career->image): ?>
                                        <img src="<?php echo e(asset('public/admin/assets/images/careers')); ?>/<?php echo e($career->image); ?>" alt="<?php echo e($career->title); ?>">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('public/assets/website/images/default-career.jpg')); ?>" alt="<?php echo e($career->title); ?>">
                                    <?php endif; ?>
                                    <div class="career-info">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('careers.apply.form')); ?>?career_id=<?php echo e($career->id); ?>" class="apply-now">
                                            Apply Now
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tab-pane fade" id="pills-<?php echo e($category->id); ?>" role="tabpanel" aria-labelledby="pills-<?php echo e($category->id); ?>-tab" tabindex="0">
                        <div class="row" id="category-careers-<?php echo e($category->id); ?>">
                            <?php $__empty_1 = true; $__currentLoopData = $category->careers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $career): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-lg-4 col-md-6 career-item visible">
                                <div class="career-card-wrapper">
                                    <?php if($career->image): ?>
                                        <img src="<?php echo e(asset('public/admin/assets/images/careers')); ?>/<?php echo e($career->image); ?>" alt="<?php echo e($career->title); ?>">
                                    ...
                                    <div class="career-info">
                                        ...
                                        <div class="career-category">
                                            <span class="category-badge"><?php echo e($category->title); ?></span>
                                        </div>
                                        <a href="<?php echo e(route('careers.apply.form')); ?>?career_id=<?php echo e($career->id); ?>" class="apply-now">
                                            Apply Now
                                            <i class="fas fa-arrow-right ms-2"></i>
        ...
        .then(data => {
            ...
            data.careers.forEach((career, index) => {
                ...
                const imageSrc = career.image 
                    ? `<?php echo e(asset('public/admin/assets/images/careers')); ?>/${career.image}`
                    : `<?php echo e(asset('public/assets/website/images/default-career.jpg')); ?>`;
                ...
                careerElement.innerHTML = `
                    <div class="career-card-wrapper">
                        ...
                        <div class="career-info">
                            ...
                            <a href="<?php echo e(route('careers.apply.form')); ?>?career_id=${career.id}" class="apply-now">
                                Apply Now
                                <i class="fas fa-arrow-right ms-2"></i>
                            </a>
                        </div>
