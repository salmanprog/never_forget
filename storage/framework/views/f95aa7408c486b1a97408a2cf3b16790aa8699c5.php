                        ...
                        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card" data-aos="fade-up" data-aos-delay="<?php echo e(($count - 1) * 100); ?>">
                                <div class="card-header" id="faqhead<?php echo e($question->id); ?>">
                                    <a href="#" class="btn btn-header-link <?php if($count != 1): ?><?php echo e('collapsed'); ?><?php endif; ?>" data-toggle="collapse" data-target="#faq<?php echo e($question->id); ?>" aria-expanded="<?php if($count ==1): ?><?php echo e('true'); ?> <?php else: ?><?php echo e('false'); ?>  <?php endif; ?>" aria-controls="faq<?php echo e($question->id); ?>"><?php echo e($question->question); ?></a>
                                </div>
