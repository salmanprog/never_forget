        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Text Message Templates</h3>
                </div>
                <div class="box-body">
                    <p class="text-muted">Text message and SMS templates will be managed here.</p>
                </div>
            </div>
        </div>
    </div>
