                ...
                <div class="box box-info">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('client_status', $employee->client_status)); ?>" name="client_status" id="client_status" placeholder="Client Status">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('client_since', $employee->client_since)); ?>" name="client_since" id="client_since" placeholder="Client Since">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('department', $employee->department)); ?>" name="department" id="department" placeholder="Department">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('employee_id', $employee->employee_id)); ?>" name="employee_id" id="employee_id" placeholder="Employee ID">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('job_title', $employee->job_title)); ?>" name="job_title" id="job_title" placeholder="Job Title">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="<?php echo e(old('hire_date', optional($employee->hire_date)->format('Y-m-d'))); ?>" name="hire_date" id="hire_date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('employment_status', $employee->employment_status)); ?>" name="employment_status" id="employment_status" placeholder="Employment Status">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('shipping_address', $employee->shipping_address)); ?>" name="shipping_address" id="shipping_address" placeholder="Shipping Address">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('city', $employee->city)); ?>" name="city" id="city" placeholder="City">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('state', $employee->state)); ?>" name="state" id="state" placeholder="State">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('zip', $employee->zip)); ?>" name="zip" id="zip" placeholder="Zip">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="<?php echo e(old('work_anniversary_date', optional($employee->work_anniversary_date)->format('Y-m-d'))); ?>" name="work_anniversary_date" id="work_anniversary_date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('favorite_color', $employee->favorite_color)); ?>" name="favorite_color" id="favorite_color" placeholder="Favorite Color">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('hobbies', $employee->hobbies)); ?>" name="hobbies" id="hobbies" placeholder="Hobbies">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('dietry_restriction', $employee->dietry_restriction)); ?>" name="dietry_restriction" id="dietry_restriction" placeholder="Dietry Restriction">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('budget_range', $employee->budget_range)); ?>" name="budget_range" id="budget_range" placeholder="Budget Range">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('gift_preferences', $employee->gift_preferences)); ?>" name="gift_preferences" id="gift_preferences" placeholder="Gift Preferences">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('occasion', $employee->occasion)); ?>" name="occasion" id="occasion" placeholder="Occasion">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" value="<?php echo e(old('gift_send_date', optional($employee->gift_send_date)->format('Y-m-d'))); ?>" name="gift_send_date" id="gift_send_date">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('payment_method', $employee->payment_method)); ?>" name="payment_method" id="payment_method" placeholder="Payment Method">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" value="<?php echo e(old('tracking_number', $employee->tracking_number)); ?>" name="tracking_number" id="tracking_number" placeholder="Tracking Number">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="delivery_notes" id="delivery_notes" rows="2" placeholder="Delivery Note"><?php echo e(old('delivery_notes', $employee->delivery_notes)); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="notes" id="notes" rows="2" placeholder="Notes"><?php echo e(old('notes', $employee->notes)); ?></textarea>
