...
<main class="inner-bg">
    <section class="inner-banner">
        <div class="container">
            <h1 class="heading fs-74" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="1000">Career
                Application</h1>
        </div>
    </section>
</main>

<section class="contact-sec career-application-sec py-150">
    <div class="container">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000"><span class="">PERSONAL DATA</span></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-30">
                                    <label for="name" class="form-label">Street Address and/or Mailing Address
                                        *</label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-30">
                                    <label class="form-label d-block">Do you have a High School Diploma or GED?
                                        *</label>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="high_school_diploma" id="diploma_yes"
                                            value="yes" class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Yes</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="high_school_diploma" id="diploma_no"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">POSITION INFORMATION <span>Check all that you are willing
                                        to work</span></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group mb-30">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="hours" id="full_time" value="full_time"
                                            class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Full Time</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="hours" id="part_time" value="part_time"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-30">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="shift" id="evenings" value="evenings"
                                            class="form-check-input">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="shift" id="graveyard" value="graveyard"
                                            class="form-check-input">
                                        <label class="form-check-label" for="diploma_no">Graveyard</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="shift" id="weekends" value="weekends"
                                            class="form-check-input">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-30">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="shift_status" id="regular" value="regular"
                                            class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Regular</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="shift_status" id="temporary" value="temporary"
                                            class="form-check-input">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-30">
                                    <label class="form-label d-block"> Are you authorized to work in the U.S. on an
                                        unrestricted basis?</label>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="authorized_work" id="authorized_work_yes"
                                            value="yes" class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Yes</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="authorized_work" id="authorized_work_no"
                                            value="no" class="form-check-input">
                                        <label class="form-check-label" for="diploma_no">No</label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-30">
                                    <label class="form-label d-block">Have you ever been convicted of a felony?
                                        (Convictions will not necessarily disqualify an applicant for
                                        employment.)</label>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="convicted" id="convicted_yes" value="yes"
                                            class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Yes</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="convicted" id="convicted_no" value="no"
                                            class="form-check-input">
                                        <label class="form-check-label" for="diploma_no">No</label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-30">
                                    <label class="form-label d-block">Have you been told the essential functions of the
                                        job or have you been viewed a copy of the job description listing the essential
                                        functions of the job?</label>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="essential_function" id="essential_function_yes"
                                            value="yes" class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Yes</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="essential_function" id="essential_function_no"
                                            value="no" class="form-check-input">
                                        <label class="form-check-label" for="diploma_no">No</label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-30">
                                    <label class="form-label d-block">Can you perform these essential functions of the
                                        job with or without reasonable accommodation?</label>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="accommodation" id="accommodation_yes"
                                            value="yes" class="form-check-input" required>
                                        <label class="form-check-label" for="diploma_yes">Yes</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="accommodation" id="accommodation_no"
                                            value="no" class="form-check-input">
                                        <label class="form-check-label" for="diploma_no">No</label>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">QUALIFICATIONS <span>Please list any education or training
                                        you feel relates to the position applied for that would help you perform the
                                        work, such as schools, colleges,
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>School</td>
                                            <td>
                                                <input type="text" id="school_1" name="school_1"
                                                    class="form-control" placeholder="Enter school name">
                                            </td>
                                            <td>
                                                <input type="text" id="degree_1" name="degree_1"
                                                    class="form-control" placeholder="Enter degree">
                                            </td>
                                            <td>
                                                <input type="text" id="address_1" name="address_1"
                                                    class="form-control" placeholder="Enter address / city / state">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>School</td>
                                            <td>
                                                <input type="text" id="school_2" name="school_2"
                                                    class="form-control" placeholder="Enter school name">
                                            </td>
                                            <td>
                                                <input type="text" id="degree_2" name="degree_2"
                                                    class="form-control" placeholder="Enter degree">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Other</td>
                                            <td>
                                                <input type="text" id="other_school" name="other_school"
                                                    class="form-control" placeholder="Enter school name">
                                            </td>
                                            <td>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">SPECIAL SKILLS <span>List any special skills or experience
                                        that you feel would help you in the position that you are applying for
                                        leadership, organizations/teams, etc.</span></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">REFERENCES <span>Please list three professional references
                                        not related to you, with full name, address, phone number, and relationship. If
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="text" id="name_1" name="name_1"
                                            ...
                                            <td>
                                                <input type="text" id="relation_1" name="relation_1"
                                                    class="form-control" placeholder="Enter Relation">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><input type="text" id="name_2" name="name_2"
                                                    class="form-control" placeholder="Enter Name"></td>
                                            <td>
                                                <input type="text" id="address_2" name="address_2"
                                                    class="form-control" placeholder="Enter Address">
                                            ...
                                            <td>
                                                <input type="text" id="relation_2" name="relation_2"
                                                    class="form-control" placeholder="Enter Relation">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><input type="text" id="name_3" name="name_3"
                                                    class="form-control" placeholder="Enter Name"></td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="text" id="relation_3" name="relation_3"
                                                    class="form-control" placeholder="Enter Relation">
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">WORK HISTORY <span>Start with your present or most recent
                                        employment and work back. Use separate sheet if necessary. (INCLUDE PAID AND
                                        UNPAID POSITIONS)</span></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">Job Title #1 </h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-30">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="contact_present_employer"
                                            id="contact_present_employer_yes" value="yes" class="form-check-input"
                                            required>
                                        <label class="form-check-label" for="diploma_yes">Yes</label>
                                    </div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="contact_present_employer"
                                            id="contact_present_employer_no" value="no" class="form-check-input">
                                        <label class="form-check-label" for="diploma_no">No</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input type="radio" name="contact_present_employer"
                                            id="contact_present_employer_na" value="n/a" class="form-check-input">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">Job Title #2 </h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">Job Title #3 </h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="heading fs-20 mb-30" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                    data-aos-duration="1000">Job Title #4 </h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-10 mb-20">
                            ...
                            <div>
                                <input type="checkbox" id="consent1" name="consent1" class="input-field mt-5" required
                                    value="1">
                            </div>
                            <div>
                                <label class="form-check-label text-start" for="consent1">I certify that all
                                    information I have provided in this application is true, complete,
                                    and accurate to the best of my knowledge. I understand that providing false or
                                    misleading information may result in disqualification from
                                    employment or termination if discovered after hire.</label>
                            </div>
                            <?php $__errorArgs = ['consent1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-10 mb-20">
                            ...
                            <div>
                                <input type="checkbox" id="consent2" name="consent2" class="input-field mt-5" required
                                    value="1">
                            </div>
                            <div>
                                <label class="form-check-label text-start" for="consent2">I understand that this is
                                    an application for employment and does not guarantee a job offer.
                                    Employment with NEVER FORGET LLC is “at-will,” meaning either the company or I may
                                    terminate employment at any time, with or without cause or notice, in accordance
                                    with applicable laws.
                                </label>
                            </div>
                            <?php $__errorArgs = ['consent2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-10 mb-20">
                            <div>
                                <input type="checkbox" id="consent3" name="consent3" class="input-field mt-5" required
                                    value="1">
                            </div>
                            <div>
                                <label class="form-check-label text-start" for="consent3">I acknowledge that I have
                                    read and understand NEVER FORGET LLC’s Equal Employment Opportunity Statement and
                                    Applicant Privacy Notice.
                                </label>
                            </div>
                            <?php $__errorArgs = ['consent3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-10 mb-20">
                            ...
                            <div>
                                <label class="form-check-label text-start" for="consent4">I authorize NEVER FORGET
                                    LLC to contact references, previous employers, and verify information as permitted
                                    by law.
                                </label>
                            </div>
                            <?php $__errorArgs = ['consent4'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form && submitBtn) {
            ...
            form.addEventListener('submit', function(e) {
                ...
                const careerId = form.querySelector('select[name="career_id"]') ? form.querySelector(
                    'select[name="career_id"]').value : form.querySelector(
                    'input[name="career_id"]').value;
