...
<section class="content-header">
    ...
    <div class="content-header-right">
        ...
        <a href="<?php echo e(route('member.friends_family.index')); ?>" class="btn btn-primary btn-sm">Back to Friends/Family</a>
    </div>
</section>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <ul class="list-unstyled" style="margin-bottom: 16px;">
                        <li><i class="fa fa-users" style="color: #081e37;"></i> <strong><?php echo e($package['friends_family']); ?></strong> friends/family included</li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php else: ?>
                    ...
                    <form action="<?php echo e(route('member.package-upgrade.paypal')); ?>" method="POST" style="margin-bottom: 16px;" id="paypal-form">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-form">
                        ...
                        <form action="<?php echo e(route('member.package-upgrade.charge')); ?>" method="POST" id="card-form">
                            <?php echo csrf_field(); ?>
