...
<div class="search-bar-container">
    <form action="<?php echo e(route('search-products')); ?>" method="GET">
        <input type="search" name="search" class="input-field bg-transparent" placeholder="Search By Product Name"
    ...
    <div class="top-bar" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <div class="d-flex gap-60 justify-content-end top-bar-content"
                        style="background-color: var(--primary-theme); padding: var(--text-13) var(--text-20); border-bottom-left-radius: var(--text-30);">
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-2 col-6">
                <div class="logo" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1000">
                    <a href="<?php echo e(route('index')); ?>" class="brand-logo-mark">
                        <img src="<?php echo e(asset('public/admin/assets/images/page')); ?>/<?php echo e($home_page_data['header_logo']); ?>"
                            alt="Never Forget">
                    ...
                    <div class="primary-navs-inner">
                        <ul class="primary-navs-list d-flex align-items-center justify-content-between">
                            ...
                            <li class="position-relative nav-dropdown-menu-wrapper">
                                <a class="btn primary-btn">About Us</a>
                            ...
                            <li class="position-relative nav-dropdown-menu-wrapper">
                                <a class="btn primary-btn <?php echo e(Route::currentRouteName() == 'corporate-solutions' || Route::currentRouteName() == 'collaborators.show' ? 'active' : ''); ?>"
                                    href="<?php echo e(route('corporate-solutions')); ?>">Corporate Solutions</a>
                                <span class="nav-dropdown-icon position-absolute"> <i
                                        class="fa-solid fa-chevron-down"></i></span>
                                <?php if(!empty($navCollaborators) && $navCollaborators->count()): ?>
                                    <ul class="nav-dropdown-menu nav-dropdown-menu--scrollable">
                                        <?php $__currentLoopData = $navCollaborators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navCollaborator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(!empty($navCollaborator->slug)): ?>
                                                <li class="nav-dropdown-list">
                                                    <a class="nav-dropdown-link"
                                                        href="<?php echo e(route('collaborators.show', $navCollaborator->slug)); ?>"><?php echo e($navCollaborator->title); ?></a>
                                                </li>
                                            <?php endif; ?>
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#quoteModal"
                                class="btn primary-btn"><span class="button-content">Get A Quote</span></a>
...
<?php /**PATH D:\xamp-new\htdocs\neverforget-updated\resources\views/layouts/website/header.blade.php ENDPATH**/ ?>