...
<tr id="id-<?php echo e($user->id); ?>">
    ...
    <td>
        ...
        <?php endif; ?>
        <?php if(strtolower((string)($user->account_type ?? '')) === 'company'): ?>
            <a href="<?php echo e(route('user.resources', $user->id)); ?>" class="btn btn-info btn-xs"><i class="fa fa-users"></i> View Resources</a>
        <?php endif; ?>
