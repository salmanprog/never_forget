		...
		<div class="row">
			<div class="col-md-12">
				<table class="table bordered">
					<tr>
						...
						<td>
							<?php if($service->image): ?>
								<img src="<?php echo e(asset('public/admin/assets/images/services')); ?>/<?php echo e($service->image); ?>" alt="vehicle Image" height="400px" width="500px">
							<?php else: ?> 
								<img src="<?php echo e(asset('public/admin/assets/images/services/no-photo1.jpg')); ?>" alt="vehicle Image" height="400px" width="500px">
							<?php endif; ?>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th>Image</th>
						<td><img src="<?php echo e(asset('public/admin/assets/images/vehicle/'.$model->image)); ?>" alt="" style="width:60px;"></td>
					</tr>
					<tr>
