						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="star-rating">
									<input type="hidden" name="rating" id="selected-rating" value="<?php echo e(old('rating', 1)); ?>">
...
<script>
	$(document).ready(function() {
		...
		const oldRating = <?php echo e(old('rating', 1)); ?>;
		...
		$('input[name="media_type"]').on('change', function() {
			if ($(this).val() === 'image') {
				...
				$('#image').val('');
				$('#banner_preview').attr('src', '<?php echo e(asset("public/admin/assets/images/default.jpg")); ?>');
			}
		});
