<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?php echo e(request()->is('company/resources*') ? 'active' : ''); ?>" style="height: auto;">
                <a href="#" class="<?php echo e(request()->is('company/resources*') ? 'active' : ''); ?>">
                ...
                <ul class="treeview-menu" style="display: <?php echo e(request()->is('company/resources*') || request()->is('company/create') || request()->is('company/edit') ? 'block' : 'none'); ?>;">
                    <li class="treeview">
                        <a href="<?php echo e(route('admin.company_employee.index')); ?>" class="<?php echo e(request()->is('company/resources') && !request()->is('company/resources/create') && !request()->is('company/resources/bulk-upload') && !request()->is('company/resources/*/edit') ? 'active' : ''); ?>">
                            <i class="fa fa-list"></i> <span>All Resources</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="<?php echo e(route('admin.company_employee.create')); ?>" class="<?php echo e(request()->is('company/resources/create') ? 'active' : ''); ?>">
                            <i class="fa fa-user-plus"></i> <span>Add Resource</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="<?php echo e(route('admin.company_employee.bulk-upload')); ?>" class="<?php echo e(request()->is('company/resources/bulk-upload') ? 'active' : ''); ?>">
