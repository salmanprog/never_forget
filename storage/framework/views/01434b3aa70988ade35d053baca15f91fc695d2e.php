                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr id="id-<?php echo e($user->id); ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <?php if($user->account_type == 'Company' && $user->administeredCompany): ?>
                                            <a href="<?php echo e(route('user.resources', $user->id)); ?>" class="btn btn-info btn-xs"><i class="fa fa-list"></i> View Resources</a>
                                        <?php endif; ?>
                                        <?php if($user->account_type == 'Individual'): ?>
                                            <a href="<?php echo e(route('user.friends_family', $user->id)); ?>" class="btn btn-info btn-xs"><i class="fa fa-list"></i> View Friends/Family</a>
                                        <?php endif; ?>
