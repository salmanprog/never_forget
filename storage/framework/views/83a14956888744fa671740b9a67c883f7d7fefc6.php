                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $enquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr id="">
                                    ...
                                    <td>
                                        <?php if($enquiry->perfectGift->images): ?>
                                            <img src="<?php echo e(asset('/public/' . $enquiry->perfectGift->images)); ?>"
                                                alt="<?php echo e($enquiry->perfectGift->title); ?>"
                                                style="width: 100px; height: 100px;">
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php echo e($enquiry->perfectGift->title); ?>
                    ...
                    <?php if(count($enquiries) > 0): ?>
                        ...
                        <form action="<?php echo e(route('perfect-gift.enquiry')); ?>" class="field-wrapper enquiry-form">
                            ...
                            <div class="row row-gap-20">
                                <input type="hidden" name="perfect_gift_ids" value="<?php echo e(implode(',', $item_ids)); ?>">
                                <?php if(!$user): ?>
                                    <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-20 justify-content-end">
                                        <a href="<?php echo e(route('shop', ['category' => 'perfect-gift'])); ?>" class="golbal-btn-submit">
                                            Add More
                                        </a>
