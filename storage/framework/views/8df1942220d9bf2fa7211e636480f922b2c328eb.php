...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo e(route('newsletter.update', $news_letters->id)); ?>" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<?php echo csrf_field(); ?>
				...
				<div class="box box-info">
					<div class="box-body">
						<!-- <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="name" value="<?php echo e($news_letters->name); ?>">
							</div>
						</div> -->
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Email <span style="color:red">*</span></label>
							<div class="col-sm-9">
								<input type="email" autocomplete="off" class="form-control" name="email" value="<?php echo e($news_letters->email); ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select name="status" class="form-control" id="">
									<option value="1" <?php echo e($news_letters->status==1?'selected':''); ?>>Active</option>
									<option value="0" <?php echo e($news_letters->status==0?'selected':''); ?>>In-Active</option>
								</select>
							</div>
						</div>
