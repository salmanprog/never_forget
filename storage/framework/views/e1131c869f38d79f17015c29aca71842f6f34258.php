...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Catering Service</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo e(route('catering_service.index')); ?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo e(route('catering_service.store')); ?>" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<?php echo csrf_field(); ?>
				<div class="box box-info">
					<div class="box-body"> 
                        <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="first_title" value="<?php echo e(old('first_title')); ?>" placeholder="Enter first title">
								<span style="color: red"><?php echo e($errors->first('first_title')); ?></span>
							</div>
						</div>
                        <div class="form-group">
							<label for="" class="col-sm-2 control-label">Second Title<span style="color: red">*</span></label>
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="second_title" value="<?php echo e(old('second_title')); ?>" placeholder="Enter second title">
								<span style="color: red"><?php echo e($errors->first('second_title')); ?></span>
							</div>
						</div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6" style="padding-top:5px">
                                ...
                                <span style="color: red"><?php echo e($errors->first('first_image')); ?></span>
                            </div>
                            <div class="col-sm-4" >
                                    <img style="width: 100px" id="banner_preview"  src="<?php echo e(asset('public/admin/assets/images/default.jpg')); ?>"  alt="Image Not Found ">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" >
                                    <img style="width: 100px" id="banner_previeww"  src="<?php echo e(asset('public/admin/assets/images/default.jpg')); ?>"  alt="Image Not Found ">
                            </div>
                        </div>
						<div class="form-group">
